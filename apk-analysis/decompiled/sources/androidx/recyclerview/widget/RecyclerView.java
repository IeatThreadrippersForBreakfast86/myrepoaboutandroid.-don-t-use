...
import androidx.recyclerview.C0496R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0496R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) throws NoSuchMethodException, SecurityException {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0496R.styleable.RecyclerView, defStyleAttr, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0496R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C0496R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C0496R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0496R.styleable.RecyclerView_android_clipToPadding, true);
        this.mEnableFastScroller = a.getBoolean(C0496R.styleable.RecyclerView_fastScrollEnabled, false);
        if (this.mEnableFastScroller) {
            StateListDrawable verticalThumbDrawable = (StateListDrawable) a.getDrawable(C0496R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
            Drawable verticalTrackDrawable = a.getDrawable(C0496R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
            StateListDrawable horizontalThumbDrawable = (StateListDrawable) a.getDrawable(C0496R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
            Drawable horizontalTrackDrawable = a.getDrawable(C0496R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    */
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure && (direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? WKSRecord.Service.CISCO_FNA : 33;
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0496R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0496R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0496R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0496R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0496R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0496R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0496R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0496R.dimen.fastscroll_margin));
    }
