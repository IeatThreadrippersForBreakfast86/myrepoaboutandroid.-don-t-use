...
public final class WithLifecycleStateKt {
    public static final <R> Object withStateAtLeast(Lifecycle $this$withStateAtLeast, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withStateAtLeast, state, dispatchNeeded$iv, lifecycleDispatcher$iv, new C04382(function0), continuation);
    }
    ...
    public static final <R> Object withCreated(Lifecycle $this$withCreated, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withCreated, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, new C04382(function0), continuation);
    }
    ...
    public static final <R> Object withStarted(Lifecycle $this$withStarted, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withStarted, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, new C04382(function0), continuation);
    }
    ...
    public static final <R> Object withResumed(Lifecycle $this$withResumed, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withResumed, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, new C04382(function0), continuation);
    }
    ...
    public static final <R> Object withStateAtLeast(LifecycleOwner $this$withStateAtLeast, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withStateAtLeast$iv, state, dispatchNeeded$iv$iv, lifecycleDispatcher$iv$iv, new C04382(function0), continuation);
    }
    ...
    public static final <R> Object withCreated(LifecycleOwner $this$withCreated, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withStateAtLeastUnchecked$iv, state$iv, dispatchNeeded$iv, lifecycleDispatcher$iv, new C04382(function0), continuation);
    }
    ...
    public static final <R> Object withStateAtLeastUnchecked(Lifecycle $this$withStateAtLeastUnchecked, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked($this$withStateAtLeastUnchecked, state, dispatchNeeded, lifecycleDispatcher, new C04382(function0), continuation);
    }
    ...
    /* compiled from: WithLifecycleState.kt */
    @Metadata(m145d1 = {"\u0000\u0004\n\u0002\b\u0004\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, m146d2 = {"<anonymous>", "R", "invoke", "()Ljava/lang/Object;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 176)
    /* renamed from: androidx.lifecycle.WithLifecycleStateKt$withStateAtLeastUnchecked$2 */
    public static final class C04382<R> extends Lambda implements Function0<R> {
        final /* synthetic */ Function0<R> $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C04382(Function0<? extends R> function0) {
            super(0);
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.INSTANCE.upTo(state)) {
                    ...
                    try {
                        ...
                        objM255constructorimpl = Result.m255constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM255constructorimpl = Result.m255constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(objM255constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    continuation3.resumeWith(Result.m255constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (dispatchNeeded) {
            lifecycleDispatcher.mo1813dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$lambda$2$$inlined$Runnable$1
        ...
        co.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            ...
            public final void invoke2(Throwable it) {
                if (lifecycleDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    ...
                    final C0437xfdb59cc4<R> c0437xfdb59cc4 = r6;
                    coroutineDispatcher.mo1813dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2$invoke$$inlined$Runnable$1
                        @Override // java.lang.Runnable
                        public final void run() {
                            lifecycle.removeObserver(c0437xfdb59cc4);
                        }
                    });
                    return;
                }
