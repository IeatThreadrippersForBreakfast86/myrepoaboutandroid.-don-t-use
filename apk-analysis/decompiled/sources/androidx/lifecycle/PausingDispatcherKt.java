...
public final class PausingDispatcherKt {
    ...
    /* compiled from: PausingDispatcher.jvm.kt */
    @Metadata(m145d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m146d2 = {"<anonymous>", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 48)
    @DebugMetadata(m161c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m162f = "PausingDispatcher.jvm.kt", m163i = {0}, m164l = {205}, m165m = "invokeSuspend", m166n = {"controller"}, m167s = {"L$0"})
    /* renamed from: androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2 */
    static final class C04252<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C04252(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C04252> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04252 c04252 = new C04252(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c04252.L$0 = obj;
            return c04252;
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle $this$whenStateAtLeast, Lifecycle.State minState, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C04252($this$whenStateAtLeast, minState, function2, null), continuation);
    }
}
