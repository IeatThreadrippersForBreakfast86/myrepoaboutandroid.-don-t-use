...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        if (this.runningJob == null) {
            this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C04081(this, null), 3, null);
        }
    }

    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m145d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 48)
    @DebugMetadata(m161c = "androidx.lifecycle.BlockRunner$maybeRun$1", m162f = "CoroutineLiveData.kt", m163i = {}, m164l = {177}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: androidx.lifecycle.BlockRunner$maybeRun$1 */
    static final class C04081 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        final /* synthetic */ BlockRunner<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04081(BlockRunner<T> blockRunner, Continuation<? super C04081> continuation) {
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            ((BlockRunner) c04081.this$0).onDone.invoke();
    ...
    public final void cancel() {
        if (this.cancellationJob == null) {
            this.cancellationJob = BuildersKt__Builders_commonKt.launch$default(this.scope, Dispatchers.getMain().getImmediate(), null, new C04071(this, null), 2, null);
            return;
        }
    ...
    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m145d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 48)
    @DebugMetadata(m161c = "androidx.lifecycle.BlockRunner$cancel$1", m162f = "CoroutineLiveData.kt", m163i = {}, m164l = {188}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    ...
    static final class C04071 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04071(BlockRunner<T> blockRunner, Continuation<? super C04071> continuation) {
            super(2, continuation);
            this.this$0 = blockRunner;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04071(this.this$0, continuation);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            if (!((BlockRunner) c04071.this$0).liveData.hasActiveObservers()) {
                Job job = ((BlockRunner) c04071.this$0).runningJob;
                if (job != null) {
                    Job.DefaultImpls.cancel$default(job, (CancellationException) null, 1, (Object) null);
                }
                ((BlockRunner) c04071.this$0).runningJob = null;
            }
            return Unit.INSTANCE;
        }
    }
