...
public final class RepeatOnLifecycleKt {
    public static final Object repeatOnLifecycle(Lifecycle $this$repeatOnLifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04263($this$repeatOnLifecycle, state, function2, null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }

    /* compiled from: RepeatOnLifecycle.kt */
    @Metadata(m145d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m146d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 48)
    @DebugMetadata(m161c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3", m162f = "RepeatOnLifecycle.kt", m163i = {}, m164l = {84}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3 */
    static final class C04263 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C04263(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C04263> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04263 c04263 = new C04263(this.$this_repeatOnLifecycle, this.$state, this.$block, continuation);
            c04263.L$0 = obj;
            return c04263;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C04263) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* compiled from: RepeatOnLifecycle.kt */
        @Metadata(m145d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m146d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 48)
        @DebugMetadata(m161c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1", m162f = "RepeatOnLifecycle.kt", m163i = {0, 0}, m164l = {166}, m165m = "invokeSuspend", m166n = {"launchedJob", "observer"}, m167s = {"L$0", "L$1"})
                            ...
                            observer.element = new LifecycleEventObserver() { // from class: androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1
                                ...
                                public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                                    ...
                                    if (event == startWorkEvent) {
                                        launchedJob3.element = BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C04271(mutex, function2, null), 3, null);
                                        return;
                                    }
                                ...
                                /* compiled from: RepeatOnLifecycle.kt */
                                @Metadata(m145d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m146d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 8, 0}, m150xi = 48)
                                @DebugMetadata(m161c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1", m162f = "RepeatOnLifecycle.kt", m163i = {0, 1}, m164l = {171, 110}, m165m = "invokeSuspend", m166n = {"$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, m167s = {"L$0", "L$0"})
                                ...
                                static final class C04271 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                    ...
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    C04271(Mutex mutex, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C04271> continuation) {
                                        super(2, continuation);
                                        this.$mutex = mutex;
                                        this.$block = function2;
                                    }
                                    ...
                                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                        return new C04271(this.$mutex, this.$block, continuation);
                                    }
                                    ...
                                    public final Object invokeSuspend(Object $result) throws Throwable {
                                        ...
                                        switch (this.label) {
                                            case 0:
                                                ResultKt.throwOnFailure($result);
                                                c04271 = this;
                                                Mutex $this$withLock_u24default$iv4 = c04271.$mutex;
                                                function2 = c04271.$block;
                                                owner$iv = null;
                                                c04271.L$0 = $this$withLock_u24default$iv4;
                                                c04271.L$1 = function2;
                                                c04271.label = 1;
                                                if ($this$withLock_u24default$iv4.lock(null, c04271) == coroutine_suspended) {
                                                ...
                                                try {
                                                    ...
                                                    c04271.L$0 = $this$withLock_u24default$iv;
                                                    c04271.L$1 = null;
                                                    c04271.label = 2;
                                                    if (CoroutineScopeKt.coroutineScope(repeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1, c04271) != coroutine_suspended) {
                                                        return coroutine_suspended;
                                                    }
                                                    owner$iv2 = owner$iv;
                                            ...
                                            case 1:
                                                c04271 = this;
                                                $this$withLock_u24default$iv2 = null;
                                                function2 = (Function2) c04271.L$1;
                                                owner$iv = null;
                                                $this$withLock_u24default$iv = (Mutex) c04271.L$0;
                                                ResultKt.throwOnFailure($result);
                                                repeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1 = new RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1(function2, null);
                                                c04271.L$0 = $this$withLock_u24default$iv;
                                                c04271.L$1 = null;
