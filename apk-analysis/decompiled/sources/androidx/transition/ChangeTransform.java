...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (this.mReparent) {
            ...
            transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0571R.id.transition_transform));
            transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0571R.id.parent_matrix));
        }
    }
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0571R.id.parent_matrix, endParentMatrix);
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            this.mView.setTag(C0571R.id.transition_transform, null);
            this.mView.setTag(C0571R.id.parent_matrix, null);
        }
    ...
    private static class Listener extends AnimatorListenerAdapter {
        ...
        private void setCurrentMatrix(Matrix currentMatrix) {
            ...
            this.mView.setTag(C0571R.id.transition_transform, this.mTempMatrix);
            this.mTransforms.restore(this.mView);
        }
    }
}
