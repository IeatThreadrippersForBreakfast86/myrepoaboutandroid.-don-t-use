...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) throws IllegalAccessException, IllegalArgumentException {
        ...
        View savedOverlayView = (View) startView.getTag(C0571R.id.save_overlay_view);
        ...
        if (overlayView != null) {
            ...
            if (!reusingOverlayView) {
                if (animator == null) {
                    ...
                    startView.setTag(C0571R.id.save_overlay_view, overlayView);
    ...
    private class OverlayListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onAnimationStart(Animator animation, boolean isReverse) {
            if (isReverse) {
                this.mStartView.setTag(C0571R.id.save_overlay_view, this.mOverlayView);
                this.mOverlayHost.getOverlay().add(this.mOverlayView);
        ...
        private void removeFromOverlay() {
            this.mStartView.setTag(C0571R.id.save_overlay_view, null);
            this.mOverlayHost.getOverlay().remove(this.mOverlayView);
