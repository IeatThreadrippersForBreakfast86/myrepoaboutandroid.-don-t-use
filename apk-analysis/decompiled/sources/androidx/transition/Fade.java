...
public class Fade extends Visibility {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        Float alpha = (Float) transitionValues.view.getTag(C0571R.id.transition_pause_alpha);
        if (alpha == null) {
    ...
    private static class FadeAnimatorListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionPause(Transition transition) {
            ...
            this.mView.setTag(C0571R.id.transition_pause_alpha, Float.valueOf(pauseAlpha));
        }

        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionResume(Transition transition) {
            this.mView.setTag(C0571R.id.transition_pause_alpha, null);
        }
    }
}
