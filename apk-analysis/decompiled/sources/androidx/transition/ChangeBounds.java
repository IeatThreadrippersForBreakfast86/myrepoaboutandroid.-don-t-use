...
public class ChangeBounds extends Transition {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        if (this.mResizeClip && (clipSize = (Rect) transitionValues.view.getTag(C0571R.id.transition_clip)) != null) {
    ...
    @Override // androidx.transition.Transition
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        View view;
        int startRight;
        int startTop;
        int endLeft;
    ...
    private static class ClipListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onAnimationStart(Animator animation, boolean isReverse) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation, boolean isReverse) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (this.mIsCanceled) {
                return;
            }
            Rect clip = null;
        ...
        public void onTransitionPause(Transition transition) {
            ...
            this.mView.setTag(C0571R.id.transition_clip, pauseClip);
        ...
        public void onTransitionResume(Transition transition) {
            Rect pauseClip = (Rect) this.mView.getTag(C0571R.id.transition_clip);
            this.mView.setTag(C0571R.id.transition_clip, null);
