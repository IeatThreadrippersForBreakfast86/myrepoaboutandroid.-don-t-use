...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0036R.styleable.AppCompatTextHelper, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this.mView, this.mView.getContext(), C0036R.styleable.AppCompatTextHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int ap = a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a.hasValue(C0036R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager, a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager, a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager, a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager, a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextHelper_android_drawableStart)) {
            this.mDrawableStartTint = createTintInfo(context, drawableManager, a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_drawableStart, 0));
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextHelper_android_drawableEnd)) {
            this.mDrawableEndTint = createTintInfo(context, drawableManager, a.getResourceId(C0036R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
        }
        a.recycle();
        ...
        if (ap != -1) {
            TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, ap, C0036R.styleable.TextAppearance);
            if (!hasPwdTm && a2.hasValue(C0036R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a2.getBoolean(C0036R.styleable.TextAppearance_textAllCaps, false);
            }
            updateTypefaceAndStyle(context, a2);
            if (a2.hasValue(C0036R.styleable.TextAppearance_textLocale)) {
                localeListString = a2.getString(C0036R.styleable.TextAppearance_textLocale);
            }
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0036R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation = a2.getString(C0036R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attrs, C0036R.styleable.TextAppearance, defStyleAttr, 0);
        if (!hasPwdTm && a3.hasValue(C0036R.styleable.TextAppearance_textAllCaps)) {
            allCaps = a3.getBoolean(C0036R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        } else {
            allCaps = allCaps2;
            allCapsSet = allCapsSet2;
        }
        if (a3.hasValue(C0036R.styleable.TextAppearance_textLocale)) {
            localeListString = a3.getString(C0036R.styleable.TextAppearance_textLocale);
        }
        if (Build.VERSION.SDK_INT >= 26 && a3.hasValue(C0036R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = a3.getString(C0036R.styleable.TextAppearance_fontVariationSettings);
        }
        if (Build.VERSION.SDK_INT >= 28 && a3.hasValue(C0036R.styleable.TextAppearance_android_textSize) && a3.getDimensionPixelSize(C0036R.styleable.TextAppearance_android_textSize, -1) == 0) {
        ...
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attrs, C0036R.styleable.AppCompatTextView);
        Drawable drawableLeft = null;
        Drawable drawableTop = null;
        int drawableLeftId = a4.getResourceId(C0036R.styleable.AppCompatTextView_drawableLeftCompat, -1);
        if (drawableLeftId != -1) {
            drawableLeft = drawableManager.getDrawable(context, drawableLeftId);
        }
        int drawableTopId = a4.getResourceId(C0036R.styleable.AppCompatTextView_drawableTopCompat, -1);
        if (drawableTopId != -1) {
            drawableTop = drawableManager.getDrawable(context, drawableTopId);
        }
        int drawableRightId = a4.getResourceId(C0036R.styleable.AppCompatTextView_drawableRightCompat, -1);
        ...
        int drawableBottomId = a4.getResourceId(C0036R.styleable.AppCompatTextView_drawableBottomCompat, -1);
        ...
        int drawableStartId = a4.getResourceId(C0036R.styleable.AppCompatTextView_drawableStartCompat, -1);
        ...
        int drawableEndId = a4.getResourceId(C0036R.styleable.AppCompatTextView_drawableEndCompat, -1);
        ...
        if (a4.hasValue(C0036R.styleable.AppCompatTextView_drawableTint)) {
            ColorStateList tintList = a4.getColorStateList(C0036R.styleable.AppCompatTextView_drawableTint);
            TextViewCompat.setCompoundDrawableTintList(this.mView, tintList);
        }
        if (a4.hasValue(C0036R.styleable.AppCompatTextView_drawableTintMode)) {
            PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(a4.getInt(C0036R.styleable.AppCompatTextView_drawableTintMode, -1), null);
            TextViewCompat.setCompoundDrawableTintMode(this.mView, tintMode);
        }
        int firstBaselineToTopHeight = a4.getDimensionPixelSize(C0036R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int lastBaselineToBottomHeight = a4.getDimensionPixelSize(C0036R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        float lineHeight = -1.0f;
        int lineHeightUnit = -1;
        if (!a4.hasValue(C0036R.styleable.AppCompatTextView_lineHeight)) {
            i = -1;
        } else {
            TypedValue peekValue = a4.peekValue(C0036R.styleable.AppCompatTextView_lineHeight);
            if (peekValue != null && peekValue.type == 5) {
                ...
                i = -1;
                lineHeight = a4.getDimensionPixelSize(C0036R.styleable.AppCompatTextView_lineHeight, -1);
            }
        }
        a4.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = a.getInt(C0036R.styleable.TextAppearance_android_textStyle, this.mStyle);
        if (Build.VERSION.SDK_INT >= 28) {
            this.mFontWeight = a.getInt(C0036R.styleable.TextAppearance_android_textFontWeight, -1);
            if (this.mFontWeight != -1) {
                this.mStyle = (this.mStyle & 2) | 0;
            }
        }
        if (a.hasValue(C0036R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0036R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            if (a.hasValue(C0036R.styleable.TextAppearance_fontFamily)) {
                fontFamilyId = C0036R.styleable.TextAppearance_fontFamily;
            } else {
                fontFamilyId = C0036R.styleable.TextAppearance_android_fontFamily;
            }
        ...
        if (a.hasValue(C0036R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int typefaceIndex = a.getInt(C0036R.styleable.TextAppearance_android_typeface, 1);
    ...
    void onSetTextAppearance(Context context, int resId) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0036R.styleable.TextAppearance);
        if (a.hasValue(C0036R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0036R.styleable.TextAppearance_textAllCaps, false));
        }
        if (a.hasValue(C0036R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0036R.styleable.TextAppearance_android_textSize, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, a);
        if (Build.VERSION.SDK_INT >= 26 && a.hasValue(C0036R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0036R.styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, fontVariation);
        }
        a.recycle();
        if (this.mFontTypeface != null) {
