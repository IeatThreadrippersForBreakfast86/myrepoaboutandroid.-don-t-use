...
class AppCompatTextViewAutoSizeHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C0036R.styleable.AppCompatTextView, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this.mTextView, this.mTextView.getContext(), C0036R.styleable.AppCompatTextView, attrs, a, defStyleAttr, 0);
        if (a.hasValue(C0036R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = a.getInt(C0036R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextView_autoSizeStepGranularity)) {
            autoSizeStepGranularityInPx = a.getDimension(C0036R.styleable.AppCompatTextView_autoSizeStepGranularity, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextView_autoSizeMinTextSize)) {
            autoSizeMinTextSizeInPx = a.getDimension(C0036R.styleable.AppCompatTextView_autoSizeMinTextSize, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextView_autoSizeMaxTextSize)) {
            autoSizeMaxTextSizeInPx = a.getDimension(C0036R.styleable.AppCompatTextView_autoSizeMaxTextSize, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE);
        }
        if (a.hasValue(C0036R.styleable.AppCompatTextView_autoSizePresetSizes) && (autoSizeStepSizeArrayResId = a.getResourceId(C0036R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
