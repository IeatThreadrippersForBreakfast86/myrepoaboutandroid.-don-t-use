...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0036R.styleable.ActivityChooserView, defStyle, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0036R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0036R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0036R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater inflater = LayoutInflater.from(getContext());
        inflater.inflate(C0036R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        ...
        FrameLayout expandButton = (FrameLayout) findViewById(C0036R.id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0036R.id.image);
    ...
    void showPopupUnchecked(int maxActivityCount) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(getContext().getString(C0036R.string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != C0036R.id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0036R.layout.abc_activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ImageView iconView = (ImageView) convertView.findViewById(C0036R.id.icon);
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    iconView.setImageDrawable(activity.loadIcon(packageManager));
                    TextView titleView = (TextView) convertView.findViewById(C0036R.id.title);
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0036R.layout.abc_activity_chooser_view_list_item, parent, false);
                        convertView2.setId(1);
                        TextView titleView2 = (TextView) convertView2.findViewById(C0036R.id.title);
                        titleView2.setText(ActivityChooserView.this.getContext().getString(C0036R.string.abc_activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                default:
