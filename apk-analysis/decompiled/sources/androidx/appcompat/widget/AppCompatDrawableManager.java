        ...
        if (INSTANCE == null) {
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                private ColorStateList createButtonColorStateList(Context context, int baseColor) {
                    ...
                    int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlHighlight);
                    int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0036R.attr.colorButtonNormal);
                ...
                private ColorStateList createSwitchThumbColorStateList(Context context) {
                    ...
                    ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context, C0036R.attr.colorSwitchThumbNormal);
                    if (thumbColor == null || !thumbColor.isStateful()) {
                        states[0] = ThemeUtils.DISABLED_STATE_SET;
                        colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0036R.attr.colorSwitchThumbNormal);
                        int i = 0 + 1;
                        states[i] = ThemeUtils.CHECKED_STATE_SET;
                        colors[i] = ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlActivated);
                        int i2 = i + 1;
                        states[i2] = ThemeUtils.EMPTY_STATE_SET;
                        colors[i2] = ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorSwitchThumbNormal);
                        int i3 = i2 + 1;
                    } else {
                        states[0] = ThemeUtils.DISABLED_STATE_SET;
                        ...
                        colors[i4] = ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlActivated);
                        int i5 = i4 + 1;
                ...
                public Drawable createDrawableFor(ResourceManagerInternal resourceManager, Context context, int resId) {
                    if (resId == C0036R.drawable.abc_cab_background_top_material) {
                        return new LayerDrawable(new Drawable[]{resourceManager.getDrawable(context, C0036R.drawable.abc_cab_background_internal_bg), resourceManager.getDrawable(context, C0036R.drawable.abc_cab_background_top_mtrl_alpha)});
                    }
                    if (resId == C0036R.drawable.abc_ratingbar_material) {
                        return getRatingBarLayerDrawable(resourceManager, context, C0036R.dimen.abc_star_big);
                    }
                    if (resId == C0036R.drawable.abc_ratingbar_indicator_material) {
                        return getRatingBarLayerDrawable(resourceManager, context, C0036R.dimen.abc_star_medium);
                    }
                    if (resId == C0036R.drawable.abc_ratingbar_small_material) {
                        return getRatingBarLayerDrawable(resourceManager, context, C0036R.dimen.abc_star_small);
                    }
                    return null;
                }
                ...
                private LayerDrawable getRatingBarLayerDrawable(ResourceManagerInternal resourceManager, Context context, int dimenResId) throws Resources.NotFoundException {
                    ...
                    Drawable star = resourceManager.getDrawable(context, C0036R.drawable.abc_star_black_48dp);
                    Drawable halfStar = resourceManager.getDrawable(context, C0036R.drawable.abc_star_half_black_48dp);
                ...
                public boolean tintDrawable(Context context, int resId, Drawable drawable) {
                    if (resId == C0036R.drawable.abc_seekbar_track_material) {
                        LayerDrawable ld = (LayerDrawable) drawable;
                        setPorterDuffColorFilter(ld.findDrawableByLayerId(R.id.background), ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                        setPorterDuffColorFilter(ld.findDrawableByLayerId(R.id.secondaryProgress), ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                        setPorterDuffColorFilter(ld.findDrawableByLayerId(R.id.progress), ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                        return true;
                    }
                    if (resId == C0036R.drawable.abc_ratingbar_material || resId == C0036R.drawable.abc_ratingbar_indicator_material || resId == C0036R.drawable.abc_ratingbar_small_material) {
                        LayerDrawable ld2 = (LayerDrawable) drawable;
                        setPorterDuffColorFilter(ld2.findDrawableByLayerId(R.id.background), ThemeUtils.getDisabledThemeAttrColor(context, C0036R.attr.colorControlNormal), AppCompatDrawableManager.DEFAULT_MODE);
                        setPorterDuffColorFilter(ld2.findDrawableByLayerId(R.id.secondaryProgress), ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                        setPorterDuffColorFilter(ld2.findDrawableByLayerId(R.id.progress), ThemeUtils.getThemeAttrColor(context, C0036R.attr.colorControlActivated), AppCompatDrawableManager.DEFAULT_MODE);
                        return true;
                    }
                    return false;
                }
                ...
                public ColorStateList getTintListForDrawableRes(Context context, int resId) {
                    if (resId == C0036R.drawable.abc_edit_text_material) {
                        return AppCompatResources.getColorStateList(context, C0036R.color.abc_tint_edittext);
                    }
                    if (resId == C0036R.drawable.abc_switch_track_mtrl_alpha) {
                        return AppCompatResources.getColorStateList(context, C0036R.color.abc_tint_switch_track);
                    }
                    if (resId == C0036R.drawable.abc_switch_thumb_material) {
                        return createSwitchThumbColorStateList(context);
                    }
                    if (resId == C0036R.drawable.abc_btn_default_mtrl_shape) {
                        return createDefaultButtonColorStateList(context);
                    }
                    if (resId == C0036R.drawable.abc_btn_borderless_material) {
                        return createBorderlessButtonColorStateList(context);
                    }
                    if (resId == C0036R.drawable.abc_btn_colored_material) {
                        return createColoredButtonColorStateList(context);
                    }
                    if (resId == C0036R.drawable.abc_spinner_mtrl_am_alpha || resId == C0036R.drawable.abc_spinner_textfield_background_material) {
                    ...
                    if (resId == C0036R.drawable.abc_seekbar_thumb_material) {
