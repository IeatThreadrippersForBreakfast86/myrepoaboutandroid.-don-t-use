...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        setBackground(bg);
        TypedArray a = context.obtainStyledAttributes(attrs, C0036R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0036R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0036R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0036R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0036R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0036R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
