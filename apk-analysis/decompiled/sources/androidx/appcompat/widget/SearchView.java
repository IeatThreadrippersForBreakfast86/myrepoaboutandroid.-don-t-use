...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0036R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0036R.styleable.SearchView, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0036R.styleable.SearchView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a.getResourceId(C0036R.styleable.SearchView_layout, C0036R.layout.abc_search_view);
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0036R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0036R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0036R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0036R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0036R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0036R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0036R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0036R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0036R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0036R.styleable.SearchView_suggestionRowLayout, C0036R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0036R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0036R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0036R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0036R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0036R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0036R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0036R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        boolean focusable = a.getBoolean(C0036R.styleable.SearchView_android_focusable, true);
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(C0036R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0036R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0036R.attr.autoCompleteTextViewStyle);
        }
