...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mLayoutParams.windowAnimations = C0036R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) throws Resources.NotFoundException {
        ...
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0036R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra2 = this.mContext.getResources().getDimensionPixelOffset(C0036R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0036R.dimen.tooltip_y_offset_touch : C0036R.dimen.tooltip_y_offset_non_touch);
