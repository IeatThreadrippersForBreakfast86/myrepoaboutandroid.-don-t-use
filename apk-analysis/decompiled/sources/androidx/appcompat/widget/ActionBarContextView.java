...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0036R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0036R.styleable.ActionMode, defStyle, 0);
        setBackground(a.getDrawable(C0036R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0036R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0036R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0036R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0036R.styleable.ActionMode_closeItemLayout, C0036R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            inflater.inflate(C0036R.layout.abc_action_bar_title_item, this);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mCloseButton = this.mClose.findViewById(C0036R.id.action_mode_close_button);
