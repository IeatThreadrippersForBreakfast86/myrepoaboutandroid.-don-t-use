...
class AppCompatBackgroundHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0036R.styleable.ViewBackgroundHelper, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this.mView, this.mView.getContext(), C0036R.styleable.ViewBackgroundHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        try {
            if (a.hasValue(C0036R.styleable.ViewBackgroundHelper_android_background)) {
                this.mBackgroundResId = a.getResourceId(C0036R.styleable.ViewBackgroundHelper_android_background, -1);
                ColorStateList tint = this.mDrawableManager.getTintList(this.mView.getContext(), this.mBackgroundResId);
                if (tint != null) {
                    setInternalBackgroundTint(tint);
                }
            }
            if (a.hasValue(C0036R.styleable.ViewBackgroundHelper_backgroundTint)) {
                ViewCompat.setBackgroundTintList(this.mView, a.getColorStateList(C0036R.styleable.ViewBackgroundHelper_backgroundTint));
            }
            if (a.hasValue(C0036R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0036R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), null));
            }
        } finally {
            a.recycle();
        }
    ...
    void onSetBackgroundResource(int resId) {
        ...
        if (this.mDrawableManager != null) {
            tintList = this.mDrawableManager.getTintList(this.mView.getContext(), resId);
        } else {
            tintList = null;
        }
