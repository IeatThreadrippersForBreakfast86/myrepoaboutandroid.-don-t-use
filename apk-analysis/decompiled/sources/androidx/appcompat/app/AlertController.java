...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0036R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0036R.styleable.AlertDialog, C0036R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0036R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0036R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0036R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0036R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0036R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0036R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0036R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0036R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        ...
        View spacer;
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C0036R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0036R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0036R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0036R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0036R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0036R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0036R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0036R.id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer2 = contentPanel.findViewById(C0036R.id.textSpacerNoButtons)) != null) {
        ...
        if (hasTopPanel) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                divider = topPanel.findViewById(C0036R.id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
            i = 0;
        } else if (contentPanel == null || (spacer = contentPanel.findViewById(C0036R.id.textSpacerNoTitle)) == null) {
            i = 0;
        } else {
            i = 0;
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0036R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0036R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0036R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0036R.id.title_template);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0036R.id.title_template);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0036R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0036R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0036R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
