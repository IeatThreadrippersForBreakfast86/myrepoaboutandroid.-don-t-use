...
public class StateListDrawableCompat extends DrawableContainerCompat {
    ...
    public void inflate(Context context, Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attrs, C0066R.styleable.StateListDrawable);
        setVisible(a.getBoolean(C0066R.styleable.StateListDrawable_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        state.mVariablePadding = a.getBoolean(C0066R.styleable.StateListDrawable_android_variablePadding, state.mVariablePadding);
        state.mConstantSize = a.getBoolean(C0066R.styleable.StateListDrawable_android_constantSize, state.mConstantSize);
        state.mEnterFadeDuration = a.getInt(C0066R.styleable.StateListDrawable_android_enterFadeDuration, state.mEnterFadeDuration);
        state.mExitFadeDuration = a.getInt(C0066R.styleable.StateListDrawable_android_exitFadeDuration, state.mExitFadeDuration);
        state.mDither = a.getBoolean(C0066R.styleable.StateListDrawable_android_dither, state.mDither);
    }
                ...
                if (depth >= innerDepth || type2 != 3) {
                    if (type2 == 2) {
                        if (depth > innerDepth) {
                            ...
                            TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attrs, C0066R.styleable.StateListDrawableItem);
                            Drawable dr = null;
                            int drawableId = a.getResourceId(C0066R.styleable.StateListDrawableItem_android_drawable, -1);
                            if (drawableId > 0) {
