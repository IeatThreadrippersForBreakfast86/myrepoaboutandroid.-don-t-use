...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0036R.styleable.DrawerArrowToggle, C0036R.attr.drawerArrowStyle, C0036R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0036R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0036R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0036R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize(Math.round(a.getDimension(C0036R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0036R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(a.getDimension(C0036R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(a.getDimension(C0036R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0036R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
