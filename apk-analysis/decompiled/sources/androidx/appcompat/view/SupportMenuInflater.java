...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0036R.styleable.MenuGroup);
            this.groupId = a.getResourceId(C0036R.styleable.MenuGroup_android_id, 0);
            this.groupCategory = a.getInt(C0036R.styleable.MenuGroup_android_menuCategory, 0);
            this.groupOrder = a.getInt(C0036R.styleable.MenuGroup_android_orderInCategory, 0);
            this.groupCheckable = a.getInt(C0036R.styleable.MenuGroup_android_checkableBehavior, 0);
            this.groupVisible = a.getBoolean(C0036R.styleable.MenuGroup_android_visible, true);
            this.groupEnabled = a.getBoolean(C0036R.styleable.MenuGroup_android_enabled, true);
            a.recycle();
        }
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = ((-65536) & tintTypedArrayObtainStyledAttributes.getInt(C0036R.styleable.MenuItem_android_menuCategory, this.groupCategory)) | (65535 & tintTypedArrayObtainStyledAttributes.getInt(C0036R.styleable.MenuItem_android_orderInCategory, this.groupOrder));
