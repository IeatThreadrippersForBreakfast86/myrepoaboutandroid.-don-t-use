...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0129R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0129R.styleable.CardView, defStyleAttr, C0129R.style.CardView);
        if (a.hasValue(C0129R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(C0129R.styleable.CardView_cardBackgroundColor);
        } else {
        ...
        int themeColorBackground2 = C0129R.styleable.CardView_cardCornerRadius;
        float radius = a.getDimension(themeColorBackground2, 0.0f);
        float elevation = a.getDimension(C0129R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation2 = a.getDimension(C0129R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0129R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0129R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0129R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = a.getDimensionPixelSize(C0129R.styleable.CardView_contentPaddingLeft, defaultPadding);
        this.mContentPadding.top = a.getDimensionPixelSize(C0129R.styleable.CardView_contentPaddingTop, defaultPadding);
        this.mContentPadding.right = a.getDimensionPixelSize(C0129R.styleable.CardView_contentPaddingRight, defaultPadding);
        this.mContentPadding.bottom = a.getDimensionPixelSize(C0129R.styleable.CardView_contentPaddingBottom, defaultPadding);
        if (elevation <= maxElevation2) {
            maxElevation = maxElevation2;
        } else {
            maxElevation = elevation;
        }
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0129R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0129R.styleable.CardView_android_minHeight, 0);
        a.recycle();
