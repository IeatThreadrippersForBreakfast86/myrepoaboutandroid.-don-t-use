    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                FragmentTransaction.C0387Op op = this.mOps.get(opNum);
                switch (op.mCmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
            ...
            switch (op.mCmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new FragmentTransaction.C0387Op(9, old, true));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                FragmentTransaction.C0387Op removeOp = new FragmentTransaction.C0387Op(3, old, true);
                ...
                case 6:
                    ...
                    if (op.mFragment == oldPrimaryNav) {
                        this.mOps.add(opNum, new FragmentTransaction.C0387Op(9, op.mFragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    } else {
                ...
                case 8:
                    this.mOps.add(opNum, new FragmentTransaction.C0387Op(9, oldPrimaryNav, true));
                    op.mFromExpandedOp = true;
                    opNum++;
            ...
            if (op.mFromExpandedOp) {
                if (op.mCmd == 8) {
                    ...
                    for (int replaceOpNum = opNum - 1; replaceOpNum >= 0; replaceOpNum--) {
                        FragmentTransaction.C0387Op potentialReplaceOp = this.mOps.get(replaceOpNum);
