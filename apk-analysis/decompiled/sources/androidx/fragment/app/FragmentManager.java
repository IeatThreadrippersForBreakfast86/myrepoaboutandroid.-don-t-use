...
import androidx.fragment.C0340R;
...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
        ...
        public final void accept(Object obj) {
            this.f$0.m217lambda$new$0$androidxfragmentappFragmentManager((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda1
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f$0.m218lambda$new$1$androidxfragmentappFragmentManager((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda2
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f$0.m219lambda$new$2$androidxfragmentappFragmentManager((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda3
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f$0.m220lambda$new$3$androidxfragmentappFragmentManager((PictureInPictureModeChangedInfo) obj);
        }
    };
    ...
    /* synthetic */ void m217lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m218lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    /* synthetic */ void m219lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m220lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0340R.id.fragment_container_view_tag);
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        if (!allowReordering && this.mCurState >= 1) {
            for (int index = startIndex; index < endIndex; index++) {
                Iterator<FragmentTransaction.C0387Op> it = records.get(index).mOps.iterator();
                while (it.hasNext()) {
                    FragmentTransaction.C0387Op op = it.next();
        ...
        for (int index2 = startIndex; index2 < endIndex; index2++) {
            ...
            if (isPop) {
                for (int opIndex = record2.mOps.size() - 1; opIndex >= 0; opIndex--) {
                    FragmentTransaction.C0387Op op2 = record2.mOps.get(opIndex);
                ...
                Iterator<FragmentTransaction.C0387Op> it2 = record2.mOps.iterator();
                while (it2.hasNext()) {
                    FragmentTransaction.C0387Op op3 = it2.next();
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> records, int startIndex, int endIndex) {
        ...
        for (int index = startIndex; index < endIndex; index++) {
            ...
            Iterator<FragmentTransaction.C0387Op> it = record.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C0387Op op = it.next();
                Fragment fragment = op.mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment f) {
        ...
        if (container != null && f.getEnterAnim() + f.getExitAnim() + f.getPopEnterAnim() + f.getPopExitAnim() > 0) {
            if (container.getTag(C0340R.id.visible_removing_fragment_view_tag) == null) {
                container.setTag(C0340R.id.visible_removing_fragment_view_tag, f);
            }
            ((Fragment) container.getTag(C0340R.id.visible_removing_fragment_view_tag)).setPopDirection(f.getPopDirection());
        }
    }
    ...
    boolean restoreBackStackState(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, String name) {
        ...
        while (it.hasNext()) {
            ...
            if (record.mBeingSaved) {
                Iterator<FragmentTransaction.C0387Op> it2 = record.mOps.iterator();
                while (it2.hasNext()) {
                    FragmentTransaction.C0387Op op = it2.next();
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, String name) {
        ...
        for (int i2 = index; i2 < this.mBackStack.size(); i2++) {
            ...
            Iterator<FragmentTransaction.C0387Op> it = record2.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C0387Op op = it.next();
    ...
    Parcelable saveAllState() {
        ...
        Bundle savedState = m216lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m216lambda$attachController$4$androidxfragmentappFragmentManager() {
        int size;
        ...
        if ((this.mHost instanceof SavedStateRegistryOwner) && parent == null) {
            ...
            registry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda4
                ...
                public final Bundle saveState() {
                    return this.f$0.m216lambda$attachController$4$androidxfragmentappFragmentManager();
                }
            });
