...
final class BackStackRecordState implements Parcelable {
    ...
    BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        int i2 = 0;
        while (i2 < size) {
            FragmentTransaction.C0387Op c0387Op = backStackRecord.mOps.get(i2);
            int i3 = i + 1;
            this.mOps[i] = c0387Op.mCmd;
            this.mFragmentWhos.add(c0387Op.mFragment != null ? c0387Op.mFragment.mWho : null);
            int i4 = i3 + 1;
            this.mOps[i3] = c0387Op.mFromExpandedOp ? 1 : 0;
            int i5 = i4 + 1;
            this.mOps[i4] = c0387Op.mEnterAnim;
            int i6 = i5 + 1;
            this.mOps[i5] = c0387Op.mExitAnim;
            int i7 = i6 + 1;
            this.mOps[i6] = c0387Op.mPopEnterAnim;
            this.mOps[i7] = c0387Op.mPopExitAnim;
            this.mOldMaxLifecycleStates[i2] = c0387Op.mOldMaxState.ordinal();
            this.mCurrentMaxLifecycleStates[i2] = c0387Op.mCurrentMaxState.ordinal();
            i2++;
            i = i7 + 1;
        }
    ...
    private void fillInBackStackRecord(BackStackRecord bse) {
        ...
        while (true) {
            ...
            if (pos < this.mOps.length) {
                FragmentTransaction.C0387Op op = new FragmentTransaction.C0387Op();
                int pos2 = pos + 1;
