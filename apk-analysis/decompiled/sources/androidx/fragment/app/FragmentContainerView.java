...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            String str = "class";
            int[] FragmentContainerView = C0340R.styleable.FragmentContainerView;
            Intrinsics.checkNotNullExpressionValue(FragmentContainerView, "FragmentContainerView");
            TypedArray $this$_init__u24lambda_u2d0 = context.obtainStyledAttributes(attrs, FragmentContainerView, 0, 0);
            if (classAttribute == null) {
                classAttribute = $this$_init__u24lambda_u2d0.getString(C0340R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm) {
        ...
        classAttribute = classAttribute == null ? $this$_init__u24lambda_u2d1.getString(C0340R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = $this$_init__u24lambda_u2d1.getString(C0340R.styleable.FragmentContainerView_android_tag);
