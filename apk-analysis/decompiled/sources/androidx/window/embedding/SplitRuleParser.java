...
@Metadata(m145d1 = {"\u0000Z\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\b\u0001\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0002J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\u0018\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\u0018\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\u0018\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\u0018\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0002J%\u0010\u0017\u001a\n\u0012\u0004\u0012\u00020\u0019\u0018\u00010\u00182\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\u001a\u001a\u00020\u001bH\u0000¢\u0006\u0002\b\u001cJ \u0010\u001d\u001a\n\u0012\u0004\u0012\u00020\u0019\u0018\u00010\u00182\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\u001e\u001a\u00020\u001bH\u0002¨\u0006\u001f"}, m146d2 = {"Landroidx/window/embedding/SplitRuleParser;", "", "()V", "buildClassName", "Landroid/content/ComponentName;", "pkg", "", "clsSeq", "", "parseActivityFilter", "Landroidx/window/embedding/ActivityFilter;", "context", "Landroid/content/Context;", "parser", "Landroid/content/res/XmlResourceParser;", "parseSplitActivityRule", "Landroidx/window/embedding/ActivityRule;", "parseSplitPairFilter", "Landroidx/window/embedding/SplitPairFilter;", "parseSplitPairRule", "Landroidx/window/embedding/SplitPairRule;", "parseSplitPlaceholderRule", "Landroidx/window/embedding/SplitPlaceholderRule;", "parseSplitRules", "", "Landroidx/window/embedding/EmbeddingRule;", "staticRuleResourceId", "", "parseSplitRules$window_release", "parseSplitXml", "splitResourceId", "window_release"}, m147k = 1, m148mv = {1, 6, 0}, m150xi = 48)
...
public final class SplitRuleParser {
    ...
    private final SplitPairRule parseSplitPairRule(Context context, XmlResourceParser parser) {
        TypedArray $this$parseSplitPairRule_u24lambda_u2d0 = context.getTheme().obtainStyledAttributes(parser, C0623R.styleable.SplitPairRule, 0, 0);
        float ratio = $this$parseSplitPairRule_u24lambda_u2d0.getFloat(C0623R.styleable.SplitPairRule_splitRatio, 0.0f);
        int minWidth = (int) $this$parseSplitPairRule_u24lambda_u2d0.getDimension(C0623R.styleable.SplitPairRule_splitMinWidth, 0.0f);
        int minSmallestWidth = (int) $this$parseSplitPairRule_u24lambda_u2d0.getDimension(C0623R.styleable.SplitPairRule_splitMinSmallestWidth, 0.0f);
        int layoutDir = $this$parseSplitPairRule_u24lambda_u2d0.getInt(C0623R.styleable.SplitPairRule_splitLayoutDirection, 3);
        boolean finishPrimaryWithSecondary = $this$parseSplitPairRule_u24lambda_u2d0.getBoolean(C0623R.styleable.SplitPairRule_finishPrimaryWithSecondary, false);
        boolean finishSecondaryWithPrimary = $this$parseSplitPairRule_u24lambda_u2d0.getBoolean(C0623R.styleable.SplitPairRule_finishSecondaryWithPrimary, true);
        boolean clearTop = $this$parseSplitPairRule_u24lambda_u2d0.getBoolean(C0623R.styleable.SplitPairRule_clearTop, false);
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser parser) {
        TypedArray $this$parseSplitPlaceholderRule_u24lambda_u2d1 = context.getTheme().obtainStyledAttributes(parser, C0623R.styleable.SplitPlaceholderRule, 0, 0);
        Object placeholderActivityIntentName = $this$parseSplitPlaceholderRule_u24lambda_u2d1.getString(C0623R.styleable.SplitPlaceholderRule_placeholderActivityName);
        float ratio = $this$parseSplitPlaceholderRule_u24lambda_u2d1.getFloat(C0623R.styleable.SplitPlaceholderRule_splitRatio, 0.0f);
        int minWidth = (int) $this$parseSplitPlaceholderRule_u24lambda_u2d1.getDimension(C0623R.styleable.SplitPlaceholderRule_splitMinWidth, 0.0f);
        int minSmallestWidth = (int) $this$parseSplitPlaceholderRule_u24lambda_u2d1.getDimension(C0623R.styleable.SplitPlaceholderRule_splitMinSmallestWidth, 0.0f);
        int layoutDir = $this$parseSplitPlaceholderRule_u24lambda_u2d1.getInt(C0623R.styleable.SplitPlaceholderRule_splitLayoutDirection, 3);
    ...
    private final SplitPairFilter parseSplitPairFilter(Context context, XmlResourceParser parser) {
        TypedArray $this$parseSplitPairFilter_u24lambda_u2d2 = context.getTheme().obtainStyledAttributes(parser, C0623R.styleable.SplitPairFilter, 0, 0);
        Object primaryActivityName = $this$parseSplitPairFilter_u24lambda_u2d2.getString(C0623R.styleable.SplitPairFilter_primaryActivityName);
        Object secondaryActivityIntentName = $this$parseSplitPairFilter_u24lambda_u2d2.getString(C0623R.styleable.SplitPairFilter_secondaryActivityName);
        String string = $this$parseSplitPairFilter_u24lambda_u2d2.getString(C0623R.styleable.SplitPairFilter_secondaryActivityAction);
        String packageName = context.getApplicationContext().getPackageName();
        Intrinsics.checkNotNullExpressionValue(packageName, "packageName");
    ...
    private final ActivityRule parseSplitActivityRule(Context context, XmlResourceParser parser) {
        TypedArray $this$parseSplitActivityRule_u24lambda_u2d3 = context.getTheme().obtainStyledAttributes(parser, C0623R.styleable.ActivityRule, 0, 0);
        boolean alwaysExpand = $this$parseSplitActivityRule_u24lambda_u2d3.getBoolean(C0623R.styleable.ActivityRule_alwaysExpand, false);
    ...
    private final ActivityFilter parseActivityFilter(Context context, XmlResourceParser parser) {
        TypedArray $this$parseActivityFilter_u24lambda_u2d4 = context.getTheme().obtainStyledAttributes(parser, C0623R.styleable.ActivityFilter, 0, 0);
        Object activityName = $this$parseActivityFilter_u24lambda_u2d4.getString(C0623R.styleable.ActivityFilter_activityName);
        String string = $this$parseActivityFilter_u24lambda_u2d4.getString(C0623R.styleable.ActivityFilter_activityAction);
        String packageName = context.getApplicationContext().getPackageName();
        Intrinsics.checkNotNullExpressionValue(packageName, "packageName");
    ...
    private final ComponentName buildClassName(String pkg, CharSequence clsSeq) {
        if (clsSeq != null) {
            if (!(clsSeq.length() == 0)) {
                ...
                if (!Intrinsics.areEqual(clsString, Marker.ANY_MARKER) && StringsKt.indexOf$default((CharSequence) clsString, '.', 0, false, 6, (Object) null) < 0) {
