    ...
    */
    public final boolean areComponentsMatching$window_release(ComponentName activityComponent, ComponentName ruleComponent) {
        ...
        if (activityComponent == null) {
            return Intrinsics.areEqual(ruleComponent.getPackageName(), Marker.ANY_MARKER) && Intrinsics.areEqual(ruleComponent.getClassName(), Marker.ANY_MARKER);
        }
        Intrinsics.checkNotNullExpressionValue(activityComponent.toString(), "activityComponent.toString()");
        if (!(!StringsKt.contains$default((CharSequence) r3, (CharSequence) Marker.ANY_MARKER, false, 2, (Object) null))) {
        ...
        if (!Intrinsics.areEqual(activityComponent.getPackageName(), ruleComponent.getPackageName())) {
            ...
            packagesMatch = wildcardMatch(packageName, packageName2);
        }
        if (!Intrinsics.areEqual(activityComponent.getClassName(), ruleComponent.getClassName())) {
            ...
            classesMatch = wildcardMatch(className, className2);
        }
    ...
    private final boolean wildcardMatch(String name, String pattern) {
        if (!StringsKt.contains$default((CharSequence) pattern, (CharSequence) Marker.ANY_MARKER, false, 2, (Object) null)) {
            return false;
        }
        if (Intrinsics.areEqual(pattern, Marker.ANY_MARKER)) {
            return true;
        }
        if (!(StringsKt.indexOf$default((CharSequence) pattern, Marker.ANY_MARKER, 0, false, 6, (Object) null) == StringsKt.lastIndexOf$default((CharSequence) pattern, Marker.ANY_MARKER, 0, false, 6, (Object) null) && StringsKt.endsWith$default(pattern, Marker.ANY_MARKER, false, 2, (Object) null))) {
