...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public WindowMetrics computeCurrentWindowMetrics(Activity activity) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Rect bounds;
    ...
    public final Rect computeWindowBoundsQ$window_release(Activity activity) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(activity, "activity");
    ...
    public final Rect computeWindowBoundsP$window_release(Activity activity) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    private final DisplayCutout getCutoutForDisplay(Display display) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
