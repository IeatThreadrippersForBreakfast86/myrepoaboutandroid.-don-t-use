...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        if (!zCanScroll) {
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, WKSRecord.Service.CISCO_FNA);
            return (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(WKSRecord.Service.CISCO_FNA)) ? false : true;
        }
        ...
        switch (event.getKeyCode()) {
            ...
            case 20:
                if (event.isAltPressed()) {
                    boolean handled3 = fullScroll(WKSRecord.Service.CISCO_FNA);
                    return handled3;
                }
                boolean handled4 = arrowScroll(WKSRecord.Service.CISCO_FNA);
                return handled4;
            case 62:
            ...
            case WKSRecord.Service.DCP /* 93 */:
                boolean handled6 = fullScroll(WKSRecord.Service.CISCO_FNA);
                return handled6;
            case 122:
                pageScroll(33);
                return false;
            case WKSRecord.Service.NTP /* 123 */:
                pageScroll(WKSRecord.Service.CISCO_FNA);
                return false;
            default:
                return false;
        }
    ...
    protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        View nextFocus;
        if (direction == 2) {
            direction = WKSRecord.Service.CISCO_FNA;
        } else if (direction == 1) {
            direction = 33;
        }
