    ...
    private static ColorStops inflateChildElements(Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (type == 2 && depth <= innerDepth && parser.getName().equals("item")) {
                TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0192R.styleable.GradientColorItem);
                boolean hasColor = a.hasValue(C0192R.styleable.GradientColorItem_android_color);
                boolean hasOffset = a.hasValue(C0192R.styleable.GradientColorItem_android_offset);
                if (!hasColor || !hasOffset) {
                    break;
                }
                int color = a.getColor(C0192R.styleable.GradientColorItem_android_color, 0);
                float offset = a.getFloat(C0192R.styleable.GradientColorItem_android_offset, 0.0f);
                a.recycle();
