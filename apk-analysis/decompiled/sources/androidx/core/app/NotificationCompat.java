...
public class NotificationCompat {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) throws Resources.NotFoundException {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                contentView.setViewVisibility(C0192R.id.icon, 0);
                contentView.setImageViewBitmap(C0192R.id.icon, createColoredBitmap(this.mBuilder.mLargeIcon, 0));
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0192R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0192R.dimen.notification_small_icon_background_padding) * 2);
                    Bitmap smallBit = createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor());
                    contentView.setImageViewBitmap(C0192R.id.right_icon, smallBit);
                    contentView.setViewVisibility(C0192R.id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0192R.id.icon, 0);
                int backgroundSize2 = res.getDimensionPixelSize(C0192R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0192R.dimen.notification_big_circle_margin);
                int iconSize2 = res.getDimensionPixelSize(C0192R.dimen.notification_small_icon_size_as_large);
                ...
                contentView.setImageViewBitmap(C0192R.id.icon, smallBit2);
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0192R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0192R.id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0192R.id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0192R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                int tooBig = res.getInteger(C0192R.integer.status_bar_notification_info_maxnum);
                if (this.mBuilder.mNumber > tooBig) {
                    contentView.setTextViewText(C0192R.id.info, res.getString(C0192R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(C0192R.id.info, f.format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0192R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0192R.id.info, 8);
                hasRightSide = false;
            }
            if (this.mBuilder.mSubText != null) {
                contentView.setTextViewText(C0192R.id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0192R.id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0192R.id.text2, 0);
                    showLine2 = true;
                    i = 8;
                    if (showLine2) {
                        if (fitIn1U) {
                            float subTextSize = res.getDimensionPixelSize(C0192R.dimen.notification_subtext_size);
                            contentView.setTextViewTextSize(C0192R.id.text, 0, subTextSize);
                        }
                        contentView.setViewPadding(C0192R.id.line1, 0, 0, 0, 0);
                    }
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        if (this.mBuilder.mUseChronometer) {
                            contentView.setViewVisibility(C0192R.id.chronometer, 0);
                            contentView.setLong(C0192R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            contentView.setBoolean(C0192R.id.chronometer, "setStarted", true);
                            if (this.mBuilder.mChronometerCountDown) {
                                Api24Impl.setChronometerCountDown(contentView, C0192R.id.chronometer, this.mBuilder.mChronometerCountDown);
                            }
                        } else {
                            contentView.setViewVisibility(C0192R.id.time, 0);
                            contentView.setLong(C0192R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        }
                        hasRightSide = true;
                    }
                    contentView.setViewVisibility(C0192R.id.right_side, !hasRightSide ? 0 : i);
                    contentView.setViewVisibility(C0192R.id.line3, showLine3 ? 0 : i);
                    return contentView;
                }
                i = 8;
                contentView.setViewVisibility(C0192R.id.text2, 8);
            } else {
                i = 8;
            }
            showLine2 = false;
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0192R.drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) throws Resources.NotFoundException {
            ...
            outerView.removeAllViews(C0192R.id.notification_main_column);
            outerView.addView(C0192R.id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0192R.id.notification_main_column, 0);
            int top = calculateTopPadding();
            outerView.setViewPadding(C0192R.id.notification_main_column_container, 0, top, 0, 0);
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0192R.id.title, 8);
            outerView.setViewVisibility(C0192R.id.text2, 8);
            outerView.setViewVisibility(C0192R.id.text, 8);
        }
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeNegativeAction() {
            int i = C0192R.drawable.ic_call_decline_low;
            int icon = C0192R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(icon, C0192R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0192R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(icon, C0192R.string.call_notification_decline_action, this.mDeclineButtonColor, C0192R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i = C0192R.drawable.ic_call_answer_video_low;
            int i2 = C0192R.drawable.ic_call_answer_low;
            int videoIcon = C0192R.drawable.ic_call_answer_video;
            int icon = C0192R.drawable.ic_call_answer;
            if (this.mAnswerIntent == null) {
                return null;
            }
            return makeAction(this.mIsVideo ? videoIcon : icon, this.mIsVideo ? C0192R.string.call_notification_answer_video_action : C0192R.string.call_notification_answer_action, this.mAnswerButtonColor, C0192R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            remoteViews.removeAllViews(C0192R.id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0192R.id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0192R.id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0192R.id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (icon != null) {
                button.setImageViewBitmap(C0192R.id.action_image, createColoredBitmap(icon, C0192R.color.notification_action_color_filter));
            }
            button.setTextViewText(C0192R.id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0192R.id.action_container, action.actionIntent);
            }
            button.setContentDescription(C0192R.id.action_container, action.title);
            return button;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m202clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m203clone() {
            WearableExtender that = new WearableExtender();
