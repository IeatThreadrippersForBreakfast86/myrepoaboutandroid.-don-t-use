...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle args) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        ...
        if (!success && action == C0192R.id.accessibility_action_clickable_span && args != null) {
    ...
    private boolean performClickableSpanAction(int clickableSpanId, View host) {
        ...
        SparseArray<WeakReference<ClickableSpan>> spans = (SparseArray) host.getTag(C0192R.id.tag_accessibility_clickable_spans);
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (List) view.getTag(C0192R.id.tag_accessibility_actions);
