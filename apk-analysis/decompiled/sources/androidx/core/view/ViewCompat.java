...
public class ViewCompat {
    ...
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0192R.id.accessibility_custom_action_0, C0192R.id.accessibility_custom_action_1, C0192R.id.accessibility_custom_action_2, C0192R.id.accessibility_custom_action_3, C0192R.id.accessibility_custom_action_4, C0192R.id.accessibility_custom_action_5, C0192R.id.accessibility_custom_action_6, C0192R.id.accessibility_custom_action_7, C0192R.id.accessibility_custom_action_8, C0192R.id.accessibility_custom_action_9, C0192R.id.accessibility_custom_action_10, C0192R.id.accessibility_custom_action_11, C0192R.id.accessibility_custom_action_12, C0192R.id.accessibility_custom_action_13, C0192R.id.accessibility_custom_action_14, C0192R.id.accessibility_custom_action_15, C0192R.id.accessibility_custom_action_16, C0192R.id.accessibility_custom_action_17, C0192R.id.accessibility_custom_action_18, C0192R.id.accessibility_custom_action_19, C0192R.id.accessibility_custom_action_20, C0192R.id.accessibility_custom_action_21, C0192R.id.accessibility_custom_action_22, C0192R.id.accessibility_custom_action_23, C0192R.id.accessibility_custom_action_24, C0192R.id.accessibility_custom_action_25, C0192R.id.accessibility_custom_action_26, C0192R.id.accessibility_custom_action_27, C0192R.id.accessibility_custom_action_28, C0192R.id.accessibility_custom_action_29, C0192R.id.accessibility_custom_action_30, C0192R.id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0192R.id.tag_accessibility_actions);
        if (actions == null) {
            ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
            view.setTag(C0192R.id.tag_accessibility_actions, actions2);
            return actions2;
        }
        return actions;
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] mimeTypes, OnReceiveContentListener listener) {
        ...
        if (mimeTypes2 != null) {
            ...
            while (true) {
                ...
                if (!mimeType.startsWith(Marker.ANY_MARKER)) {
                    i++;
                } else {
        ...
        view.setTag(C0192R.id.tag_on_receive_content_mime_types, mimeTypes2);
        view.setTag(C0192R.id.tag_on_receive_content_listener, listener);
    }
    ...
    public static String[] getOnReceiveContentMimeTypes(View view) {
        ...
        return (String[]) view.getTag(C0192R.id.tag_on_receive_content_mime_types);
    }
    ...
    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat payload) {
        ...
        OnReceiveContentListener listener = (OnReceiveContentListener) view.getTag(C0192R.id.tag_on_receive_content_listener);
        if (listener != null) {
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat listener) {
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) view.getTag(C0192R.id.tag_unhandled_key_listeners);
        if (viewListeners == null) {
            viewListeners = new ArrayList<>();
            view.setTag(C0192R.id.tag_unhandled_key_listeners, viewListeners);
        }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m37at(root).preDispatch(evt);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View root, KeyEvent evt) {
        ...
        return UnhandledKeyEventManager.m37at(root).dispatch(root, evt);
    }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0192R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.1
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0192R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0192R.id.tag_state_description, CharSequence.class, 64, 30) { // from class: androidx.core.view.ViewCompat.3
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0192R.id.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // androidx.core.view.ViewCompat.AccessibilityViewProperty
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m37at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0192R.id.tag_unhandled_key_event_manager);
            if (manager == null) {
                UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
                root.setTag(C0192R.id.tag_unhandled_key_event_manager, manager2);
                return manager2;
            }
            return manager;
        }
        ...
        private boolean onUnhandledKeyEvent(View v, KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0192R.id.tag_unhandled_key_listeners);
            if (viewListeners != null) {
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View v, final OnApplyWindowInsetsListener listener) {
            if (Build.VERSION.SDK_INT < 30) {
                v.setTag(C0192R.id.tag_on_apply_window_listener, listener);
            }
            if (listener == null) {
                View.OnApplyWindowInsetsListener compatInsetsAnimationCallback = (View.OnApplyWindowInsetsListener) v.getTag(C0192R.id.tag_window_insets_animation_callback);
        ...
        static void callCompatInsetAnimationCallback(WindowInsets insets, View v) {
            View.OnApplyWindowInsetsListener insetsAnimationCallback = (View.OnApplyWindowInsetsListener) v.getTag(C0192R.id.tag_window_insets_animation_callback);
    ...
    static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0192R.id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(C0192R.id.tag_unhandled_key_listeners, viewListeners);
            }
