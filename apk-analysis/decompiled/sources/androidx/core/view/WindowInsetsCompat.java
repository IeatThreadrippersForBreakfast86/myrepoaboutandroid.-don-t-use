...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int left, int top, int right, int bottom) {
        return new Builder(this).setSystemWindowInsets(Insets.m11of(left, top, right, bottom)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect systemWindowInsets) {
        return new Builder(this).setSystemWindowInsets(Insets.m12of(systemWindowInsets)).build();
    }
    ...
    private static class Impl20 extends Impl {
            ...
            switch (type) {
                case 1:
                    if (ignoreVisibility) {
                        ...
                        return Insets.m11of(0, Math.max(rootStable.top, getSystemWindowInsets().top), 0, 0);
                    }
                    Insets rootStable2 = getSystemWindowInsets();
                    return Insets.m11of(0, rootStable2.top, 0, 0);
                case 2:
                    if (ignoreVisibility) {
                        Insets rootStable3 = getRootStableInsets();
                        Insets stable = getStableInsets();
                        return Insets.m11of(Math.max(rootStable3.left, stable.left), 0, Math.max(rootStable3.right, stable.right), Math.max(rootStable3.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m11of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable4.bottom) {
                        return Insets.m11of(0, 0, 0, systemWindow2.bottom);
                    }
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m11of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        private Insets getVisibleInsets(View rootView) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                if (visibleRect != null) {
                    return Insets.m12of(visibleRect);
                }
                return null;
    ...
    static Insets insetInsets(Insets insets, int left, int top, int right, int bottom) {
        ...
        return Insets.m11of(newLeft, newTop, newRight, newBottom);
    }
            ...
            try {
                ...
                if (attachInfo != null) {
                    ...
                    if (stableInsets != null && visibleInsets != null) {
                        WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m12of(stableInsets)).setSystemWindowInsets(Insets.m12of(visibleInsets)).build();
