...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0188R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    this.mReferenceIds = a.getString(attr);
                    setIds(this.mReferenceIds);
                } else if (attr == C0188R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String referenceId) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        ...
        if (rscId == 0) {
            try {
                Field field = C0188R.id.class.getField(referenceId);
