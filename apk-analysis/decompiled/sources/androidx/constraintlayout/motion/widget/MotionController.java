    ...
    */
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (this.mSpline != null) {
            ...
            c = 1;
            float float_l = this.mStartMotionPath.f57x + ((this.mEndMotionPath.f57x - this.mStartMotionPath.f57x) * position);
            float float_t = this.mStartMotionPath.f58y + ((this.mEndMotionPath.f58y - this.mStartMotionPath.f58y) * position);
