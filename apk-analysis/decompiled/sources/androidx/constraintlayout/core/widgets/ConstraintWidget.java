    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.mParent == null) {
            ...
            boolean z15 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            boolean z16 = this.mParent != null && this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
        ...
        if (this.resolvedHorizontal || this.resolvedVertical) {
            if (this.resolvedHorizontal) {
                linearSystem.addEquality(solverVariableCreateObjectVariable, this.f41mX);
                linearSystem.addEquality(solverVariableCreateObjectVariable2, this.f41mX + this.mWidth);
            ...
            if (this.resolvedVertical) {
                linearSystem.addEquality(solverVariableCreateObjectVariable3, this.f42mY);
                linearSystem.addEquality(solverVariableCreateObjectVariable4, this.f42mY + this.mHeight);
                if (this.mBaseline.hasDependents()) {
                    linearSystem.addEquality(solverVariableCreateObjectVariable5, this.f42mY + this.mBaselineDistance);
                }
        ...
        if (this.mDimensionRatio <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i11 == 3 && i12 == 3) {
                ...
                int i15 = (int) (this.mResolvedDimensionRatio * this.mWidth);
                if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                    i4 = i15;
                    i = i12;
                    i2 = i11;
        ...
        boolean z19 = z6 && (this.mResolvedDimensionRatioSide == 0 || this.mResolvedDimensionRatioSide == -1);
        boolean z20 = z6 && (this.mResolvedDimensionRatioSide == 1 || this.mResolvedDimensionRatioSide == -1);
        boolean z21 = this.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
        if (!z21) {
            i5 = i3;
        } else {
            i5 = 0;
        ...
        boolean z22 = this.mIsInBarrier[0];
        boolean z23 = this.mIsInBarrier[1];
        if (this.mHorizontalResolution == 2 || this.resolvedHorizontal) {
            ...
            solverVariable4 = solverVariableCreateObjectVariable2;
            solverVariable5 = solverVariableCreateObjectVariable;
            applyConstraints(linearSystem, true, z2, z8, this.isTerminalWidget[0], this.mParent != null ? linearSystem.createObjectVariable(this.mParent.mLeft) : null, solverVariableCreateObjectVariable6, this.mListDimensionBehaviors[0], z21, this.mLeft, this.mRight, this.f41mX, i5, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z19, this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT, z4, z5, z22, i2, i, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z7);
        } else if (z) {
            linearSystem.addEquality(solverVariableCreateObjectVariable, this.horizontalRun.start.value);
            linearSystem.addEquality(solverVariableCreateObjectVariable2, this.horizontalRun.end.value);
        ...
        if (!z) {
            ...
            if (!z11 && !constraintWidget.resolvedVertical) {
                boolean z25 = (constraintWidget.mListDimensionBehaviors[r2] == DimensionBehaviour.WRAP_CONTENT && (constraintWidget instanceof ConstraintWidgetContainer)) ? r2 : i7;
                if (!z25) {
                    i8 = i4;
                } else {
                    i8 = 0;
                ...
                if (constraintWidget.mBaselineDistance > 0 || constraintWidget.mVisibility == i6) {
                    if (constraintWidget.mBaseline.mTarget != null) {
                        linearSystem2.addEquality(solverVariable6, solverVariable8, getBaselineDistance(), i6);
                        linearSystem2.addEquality(solverVariable6, linearSystem2.createObjectVariable(constraintWidget.mBaseline.mTarget), constraintWidget.mBaseline.getMargin(), i6);
                        if (z8) {
                            linearSystem2.addGreaterThan(solverVariableCreateObjectVariable7, linearSystem2.createObjectVariable(constraintWidget.mBottom), i7, 5);
                        }
                        z12 = false;
                        applyConstraints(linearSystem, false, z8, z9, constraintWidget.isTerminalWidget[r2], solverVariableCreateObjectVariable8, solverVariableCreateObjectVariable7, constraintWidget.mListDimensionBehaviors[r2], z25, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.f42mY, i8, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[r2], constraintWidget.mVerticalBiasPercent, z20, constraintWidget.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT, z5, z4, z23, i, i2, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z12);
                    } else {
                        if (constraintWidget.mVisibility == i6) {
                            linearSystem2.addEquality(solverVariable6, solverVariable8, constraintWidget.mBaseline.getMargin(), i6);
                        } else {
                            linearSystem2.addEquality(solverVariable6, solverVariable8, getBaselineDistance(), i6);
                        }
                        z12 = z7;
