    ...
    protected void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0188R.styleable.ConstraintLayout_Layout_circularflow_viewCenter) {
                    this.mViewCenter = a.getResourceId(attr, 0);
                } else if (attr == C0188R.styleable.ConstraintLayout_Layout_circularflow_angles) {
                    this.mReferenceAngles = a.getString(attr);
                    setAngles(this.mReferenceAngles);
                } else if (attr == C0188R.styleable.ConstraintLayout_Layout_circularflow_radiusInDP) {
                    this.mReferenceRadius = a.getString(attr);
                    setRadius(this.mReferenceRadius);
                } else if (attr == C0188R.styleable.ConstraintLayout_Layout_circularflow_defaultAngle) {
                ...
                } else if (attr == C0188R.styleable.ConstraintLayout_Layout_circularflow_defaultRadius) {
