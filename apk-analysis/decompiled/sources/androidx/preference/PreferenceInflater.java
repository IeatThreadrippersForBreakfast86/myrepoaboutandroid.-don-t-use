...
class PreferenceInflater {
    ...
    public Preference inflate(int resource, PreferenceGroup root) throws Resources.NotFoundException {
    ...
    private Preference createItem(String name, String[] prefixes, AttributeSet attrs) throws InflateException, NoSuchMethodException, ClassNotFoundException, SecurityException {
                ...
                try {
                    ...
                    if (prefixes == null || prefixes.length == 0) {
                        ...
                        while (true) {
                            ...
                            try {
                                clazz = Class.forName(prefix + name, z, classLoader);
                                break;
