...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mLayoutResId = C0483R.layout.preference;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0483R.styleable.Preference, defStyleAttr, defStyleRes);
        this.mIconResId = TypedArrayUtils.getResourceId(a, C0483R.styleable.Preference_icon, C0483R.styleable.Preference_android_icon, 0);
        this.mKey = TypedArrayUtils.getString(a, C0483R.styleable.Preference_key, C0483R.styleable.Preference_android_key);
        this.mTitle = TypedArrayUtils.getText(a, C0483R.styleable.Preference_title, C0483R.styleable.Preference_android_title);
        this.mSummary = TypedArrayUtils.getText(a, C0483R.styleable.Preference_summary, C0483R.styleable.Preference_android_summary);
        this.mOrder = TypedArrayUtils.getInt(a, C0483R.styleable.Preference_order, C0483R.styleable.Preference_android_order, Integer.MAX_VALUE);
        this.mFragment = TypedArrayUtils.getString(a, C0483R.styleable.Preference_fragment, C0483R.styleable.Preference_android_fragment);
        this.mLayoutResId = TypedArrayUtils.getResourceId(a, C0483R.styleable.Preference_layout, C0483R.styleable.Preference_android_layout, C0483R.layout.preference);
        this.mWidgetLayoutResId = TypedArrayUtils.getResourceId(a, C0483R.styleable.Preference_widgetLayout, C0483R.styleable.Preference_android_widgetLayout, 0);
        this.mEnabled = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_enabled, C0483R.styleable.Preference_android_enabled, true);
        this.mSelectable = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_selectable, C0483R.styleable.Preference_android_selectable, true);
        this.mPersistent = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_persistent, C0483R.styleable.Preference_android_persistent, true);
        this.mDependencyKey = TypedArrayUtils.getString(a, C0483R.styleable.Preference_dependency, C0483R.styleable.Preference_android_dependency);
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_allowDividerAbove, C0483R.styleable.Preference_allowDividerAbove, this.mSelectable);
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_allowDividerBelow, C0483R.styleable.Preference_allowDividerBelow, this.mSelectable);
        if (a.hasValue(C0483R.styleable.Preference_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(a, C0483R.styleable.Preference_defaultValue);
        } else if (a.hasValue(C0483R.styleable.Preference_android_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(a, C0483R.styleable.Preference_android_defaultValue);
        }
        this.mShouldDisableView = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_shouldDisableView, C0483R.styleable.Preference_android_shouldDisableView, true);
        this.mHasSingleLineTitleAttr = a.hasValue(C0483R.styleable.Preference_singleLineTitle);
        if (this.mHasSingleLineTitleAttr) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_singleLineTitle, C0483R.styleable.Preference_android_singleLineTitle, true);
        }
        this.mIconSpaceReserved = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_iconSpaceReserved, C0483R.styleable.Preference_android_iconSpaceReserved, false);
        this.mVisible = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_isPreferenceVisible, C0483R.styleable.Preference_isPreferenceVisible, true);
        this.mCopyingEnabled = TypedArrayUtils.getBoolean(a, C0483R.styleable.Preference_enableCopying, C0483R.styleable.Preference_enableCopying, false);
        a.recycle();
    }
    ...
    public Preference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, C0483R.attr.preferenceStyle, android.R.attr.preferenceStyle));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View imageFrame = holder.findViewById(C0483R.id.icon_frame);
        if (imageFrame == null) {
    ...
    private static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
            ...
            menu.add(0, 0, 0, C0483R.string.copy).setOnMenuItemClickListener(this);
        }

        @Override // android.view.MenuItem.OnMenuItemClickListener
        public boolean onMenuItemClick(MenuItem item) {
            ClipboardManager clipboard = (ClipboardManager) this.mPreference.getContext().getSystemService("clipboard");
            CharSequence summary = this.mPreference.getSummary();
            ClipData clip = ClipData.newPlainText(Preference.CLIPBOARD_ID, summary);
            clipboard.setPrimaryClip(clip);
            Toast.makeText(this.mPreference.getContext(), this.mPreference.getContext().getString(C0483R.string.preference_copied, summary), 0).show();
            return true;
        }
    }
}
