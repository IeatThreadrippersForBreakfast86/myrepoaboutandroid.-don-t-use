...
public class MaterialResources {
    ...
    public static int getUnscaledTextSize(Context context, int textAppearance, int defValue) throws Resources.NotFoundException {
        ...
        TypedArray a = context.obtainStyledAttributes(textAppearance, C0633R.styleable.TextAppearance);
        TypedValue v = new TypedValue();
        boolean available = a.getValue(C0633R.styleable.TextAppearance_android_textSize, v);
        a.recycle();
        if (!available) {
            return defValue;
        }
