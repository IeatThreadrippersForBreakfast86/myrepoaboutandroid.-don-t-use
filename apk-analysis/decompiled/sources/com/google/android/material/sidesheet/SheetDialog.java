...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C0633R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C0633R.id.touch_outside;
    ...
    /* synthetic */ void m121x401f75dd(View v) {
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        if (window != null && this.sheet != null && (this.sheet.getLayoutParams() instanceof CoordinatorLayout.LayoutParams)) {
            ...
            if (absoluteGravity == 3) {
                i = C0633R.style.Animation_Material3_SideSheetDialog_Left;
            } else {
                i = C0633R.style.Animation_Material3_SideSheetDialog_Right;
            }
