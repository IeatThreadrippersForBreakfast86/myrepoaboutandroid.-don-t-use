...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0633R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0633R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0633R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int surfaceColor = MaterialColors.getColor(context2, C0633R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray a = context2.obtainStyledAttributes(null, C0633R.styleable.MaterialAlertDialog, DEF_STYLE_ATTR, DEF_STYLE_RES);
        int backgroundColor = a.getColor(C0633R.styleable.MaterialAlertDialog_backgroundTint, surfaceColor);
        a.recycle();
