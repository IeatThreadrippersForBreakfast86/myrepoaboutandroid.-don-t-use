...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    private static final int[] INDETERMINATE_STATE_SET = {C0633R.attr.state_indeterminate};
    private static final int[] ERROR_STATE_SET = {C0633R.attr.state_error};
    private static final int[][] CHECKBOX_STATES = {new int[]{R.attr.state_enabled, C0633R.attr.state_error}, new int[]{R.attr.state_enabled, R.attr.state_checked}, new int[]{R.attr.state_enabled, -16842912}, new int[]{-16842910, R.attr.state_checked}, new int[]{-16842910, -16842912}};
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.checkboxStyle);
    }
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.transitionToUnchecked = AnimatedVectorDrawableCompat.create(getContext(), C0633R.drawable.mtrl_checkbox_button_checked_unchecked);
        ...
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0633R.styleable.MaterialCheckBox, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.buttonIconDrawable = attributes.getDrawable(C0633R.styleable.MaterialCheckBox_buttonIcon);
        if (this.buttonDrawable != null && ThemeEnforcement.isMaterial3Theme(context2) && isButtonDrawableLegacy(attributes)) {
            super.setButtonDrawable((Drawable) null);
            this.buttonDrawable = AppCompatResources.getDrawable(context2, C0633R.drawable.mtrl_checkbox_button);
            this.usingMaterialButtonDrawable = true;
            if (this.buttonIconDrawable == null) {
                this.buttonIconDrawable = AppCompatResources.getDrawable(context2, C0633R.drawable.mtrl_checkbox_button_icon);
            }
        }
        this.buttonIconTintList = MaterialResources.getColorStateList(context2, attributes, C0633R.styleable.MaterialCheckBox_buttonIconTint);
        this.buttonIconTintMode = ViewUtils.parseTintMode(attributes.getInt(C0633R.styleable.MaterialCheckBox_buttonIconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.useMaterialThemeColors = attributes.getBoolean(C0633R.styleable.MaterialCheckBox_useMaterialThemeColors, false);
        this.centerIfNoTextEnabled = attributes.getBoolean(C0633R.styleable.MaterialCheckBox_centerIfNoTextEnabled, true);
        this.errorShown = attributes.getBoolean(C0633R.styleable.MaterialCheckBox_errorShown, false);
        this.errorAccessibilityLabel = attributes.getText(C0633R.styleable.MaterialCheckBox_errorAccessibilityLabel);
        if (attributes.hasValue(C0633R.styleable.MaterialCheckBox_checkedState)) {
            setCheckedState(attributes.getInt(C0633R.styleable.MaterialCheckBox_checkedState, 0));
        }
        attributes.recycle();
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        ...
        if ((this.buttonDrawable instanceof AnimatedStateListDrawable) && this.transitionToUnchecked != null) {
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C0633R.id.checked, C0633R.id.unchecked, this.transitionToUnchecked, false);
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C0633R.id.indeterminate, C0633R.id.unchecked, this.transitionToUnchecked, false);
        }
    }
    ...
    private String getButtonStateDescription() {
        if (this.checkedState == 1) {
            return getResources().getString(C0633R.string.mtrl_checkbox_state_description_checked);
        }
        if (this.checkedState == 0) {
            return getResources().getString(C0633R.string.mtrl_checkbox_state_description_unchecked);
        }
        return getResources().getString(C0633R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray attributes) {
        int buttonResourceId = attributes.getResourceId(C0633R.styleable.MaterialCheckBox_android_button, 0);
        int buttonCompatResourceId = attributes.getResourceId(C0633R.styleable.MaterialCheckBox_buttonCompat, 0);
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int colorControlActivated = MaterialColors.getColor(this, C0633R.attr.colorControlActivated);
            int colorError = MaterialColors.getColor(this, C0633R.attr.colorError);
            int colorSurface = MaterialColors.getColor(this, C0633R.attr.colorSurface);
            int colorOnSurface = MaterialColors.getColor(this, C0633R.attr.colorOnSurface);
