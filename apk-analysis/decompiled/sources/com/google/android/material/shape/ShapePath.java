...
public class ShapePath {
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            float height = this.operation.f165y - this.startY;
            float width = this.operation.f164x - this.startX;
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f165y - this.startY) / (this.operation.f164x - this.startX)));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                double length1 = Math.hypot(this.operation1.f164x - this.startX, this.operation1.f165y - this.startY);
                double length22 = Math.hypot(this.operation2.f164x - this.operation1.f164x, this.operation2.f165y - this.operation1.f165y);
                ...
                this.renderMatrix.set(transform);
                this.renderMatrix.preTranslate(this.operation1.f164x, this.operation1.f165y);
                this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f165y - this.startY) / (this.operation1.f164x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f165y - this.operation1.f165y) / (this.operation2.f164x - this.operation1.f164x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix transform, Path path) {
            ...
            path.lineTo(this.f164x, this.f165y);
