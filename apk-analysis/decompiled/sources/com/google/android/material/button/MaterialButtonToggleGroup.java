...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.MaterialButtonToggleGroup, defStyleAttr, DEF_STYLE_RES, new int[0]);
        setSingleSelection(attributes.getBoolean(C0633R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.defaultCheckId = attributes.getResourceId(C0633R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = attributes.getBoolean(C0633R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
        setChildrenDrawingOrderEnabled(true);
        setEnabled(attributes.getBoolean(C0633R.styleable.MaterialButtonToggleGroup_android_enabled, true));
        attributes.recycle();
