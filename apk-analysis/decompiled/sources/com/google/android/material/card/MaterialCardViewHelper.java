...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView card, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray cardViewAttributes = card.getContext().obtainStyledAttributes(attrs, C0633R.styleable.CardView, defStyleAttr, C0633R.style.CardView);
        if (cardViewAttributes.hasValue(C0633R.styleable.CardView_cardCornerRadius)) {
            shapeAppearanceModelBuilder.setAllCornerSizes(cardViewAttributes.getDimension(C0633R.styleable.CardView_cardCornerRadius, 0.0f));
        }
        this.foregroundContentDrawable = new MaterialShapeDrawable();
        setShapeAppearanceModel(shapeAppearanceModelBuilder.build());
        this.iconFadeAnimInterpolator = MotionUtils.resolveThemeInterpolator(this.materialCardView.getContext(), C0633R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.iconFadeInAnimDuration = MotionUtils.resolveThemeDuration(this.materialCardView.getContext(), C0633R.attr.motionDurationShort2, DEFAULT_FADE_ANIM_DURATION);
        this.iconFadeOutAnimDuration = MotionUtils.resolveThemeDuration(this.materialCardView.getContext(), C0633R.attr.motionDurationShort1, DEFAULT_FADE_ANIM_DURATION);
        cardViewAttributes.recycle();
    }

    void loadFromAttributes(TypedArray attributes) {
        this.strokeColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0633R.styleable.MaterialCardView_strokeColor);
        if (this.strokeColor == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = attributes.getDimensionPixelSize(C0633R.styleable.MaterialCardView_strokeWidth, 0);
        this.checkable = attributes.getBoolean(C0633R.styleable.MaterialCardView_android_checkable, false);
        this.materialCardView.setLongClickable(this.checkable);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0633R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), attributes, C0633R.styleable.MaterialCardView_checkedIcon));
        setCheckedIconSize(attributes.getDimensionPixelSize(C0633R.styleable.MaterialCardView_checkedIconSize, 0));
        setCheckedIconMargin(attributes.getDimensionPixelSize(C0633R.styleable.MaterialCardView_checkedIconMargin, 0));
        this.checkedIconGravity = attributes.getInteger(C0633R.styleable.MaterialCardView_checkedIconGravity, 8388661);
        this.rippleColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0633R.styleable.MaterialCardView_rippleColor);
        if (this.rippleColor == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C0633R.attr.colorControlHighlight));
        }
        ColorStateList foregroundColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0633R.styleable.MaterialCardView_cardForegroundColor);
    ...
    public void animateCheckedIcon(boolean checked) {
        ...
        this.iconAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.MaterialCardViewHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m56xa4d79c2b(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m56xa4d79c2b(ValueAnimator animation) {
    ...
    void setCheckedIcon(Drawable checkedIcon) {
        ...
        if (this.clickableForegroundDrawable != null) {
            this.clickableForegroundDrawable.setDrawableByLayerId(C0633R.id.mtrl_card_checked_layer_id, this.checkedIcon);
        }
    }
    ...
    private Drawable getClickableForeground() {
        ...
        if (this.clickableForegroundDrawable == null) {
            ...
            this.clickableForegroundDrawable.setId(2, C0633R.id.mtrl_card_checked_layer_id);
        }
