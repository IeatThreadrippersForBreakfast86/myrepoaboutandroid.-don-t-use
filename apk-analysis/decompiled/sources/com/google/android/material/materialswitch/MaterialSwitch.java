...
public class MaterialSwitch extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Material3_CompoundButton_MaterialSwitch;
    private static final int[] STATE_SET_WITH_ICON = {C0633R.attr.state_with_icon};
    ...
    public MaterialSwitch(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.materialSwitchStyle);
    }
    ...
    public MaterialSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0633R.styleable.MaterialSwitch, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.thumbIconDrawable = attributes.getDrawable(C0633R.styleable.MaterialSwitch_thumbIcon);
        this.thumbIconSize = attributes.getDimensionPixelSize(C0633R.styleable.MaterialSwitch_thumbIconSize, -1);
        this.thumbIconTintList = attributes.getColorStateList(C0633R.styleable.MaterialSwitch_thumbIconTint);
        this.thumbIconTintMode = ViewUtils.parseTintMode(attributes.getInt(C0633R.styleable.MaterialSwitch_thumbIconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.trackDecorationDrawable = attributes.getDrawable(C0633R.styleable.MaterialSwitch_trackDecoration);
        this.trackDecorationTintList = attributes.getColorStateList(C0633R.styleable.MaterialSwitch_trackDecorationTint);
        this.trackDecorationTintMode = ViewUtils.parseTintMode(attributes.getInt(C0633R.styleable.MaterialSwitch_trackDecorationTintMode, -1), PorterDuff.Mode.SRC_IN);
        attributes.recycle();
