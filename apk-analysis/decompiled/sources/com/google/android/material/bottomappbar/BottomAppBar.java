...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_BottomAppBar;
    private static final int FAB_ALIGNMENT_ANIM_DURATION_ATTR = C0633R.attr.motionDurationLong2;
    private static final int FAB_ALIGNMENT_ANIM_EASING_ATTR = C0633R.attr.motionEasingEmphasizedInterpolator;
    ...
    public BottomAppBar(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.BottomAppBar, defStyleAttr, DEF_STYLE_RES, new int[0]);
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context2, a, C0633R.styleable.BottomAppBar_backgroundTint);
        if (a.hasValue(C0633R.styleable.BottomAppBar_navigationIconTint)) {
            setNavigationIconTint(a.getColor(C0633R.styleable.BottomAppBar_navigationIconTint, -1));
        }
        int elevation = a.getDimensionPixelSize(C0633R.styleable.BottomAppBar_elevation, 0);
        float fabCradleMargin = a.getDimensionPixelOffset(C0633R.styleable.BottomAppBar_fabCradleMargin, 0);
        float fabCornerRadius = a.getDimensionPixelOffset(C0633R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float fabVerticalOffset = a.getDimensionPixelOffset(C0633R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = a.getInt(C0633R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = a.getInt(C0633R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.fabAnchorMode = a.getInt(C0633R.styleable.BottomAppBar_fabAnchorMode, 1);
        this.removeEmbeddedFabElevation = a.getBoolean(C0633R.styleable.BottomAppBar_removeEmbeddedFabElevation, true);
        this.menuAlignmentMode = a.getInt(C0633R.styleable.BottomAppBar_menuAlignmentMode, 0);
        this.hideOnScroll = a.getBoolean(C0633R.styleable.BottomAppBar_hideOnScroll, false);
        this.paddingBottomSystemWindowInsets = a.getBoolean(C0633R.styleable.BottomAppBar_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = a.getBoolean(C0633R.styleable.BottomAppBar_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = a.getBoolean(C0633R.styleable.BottomAppBar_paddingRightSystemWindowInsets, false);
        this.fabAlignmentModeEndMargin = a.getDimensionPixelOffset(C0633R.styleable.BottomAppBar_fabAlignmentModeEndMargin, -1);
        boolean addElevationShadow = a.getBoolean(C0633R.styleable.BottomAppBar_addElevationShadow, true);
        a.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C0633R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
    ...
    protected int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int fabAlignmentMode, boolean fabAttached) throws Resources.NotFoundException {
        int iMax;
        ...
        if (getNavigationIcon() == null) {
            int horizontalMargin = getResources().getDimensionPixelOffset(C0633R.dimen.m3_bottomappbar_horizontal_padding);
                ...
                public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) throws Resources.NotFoundException {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        if (child.fabAnchorMode == 1) {
                            ...
                            int bottomMargin = child.getResources().getDimensionPixelOffset(C0633R.dimen.mtrl_bottomappbar_fab_bottom_margin);
            ...
            if (dependentView != null && !ViewCompat.isLaidOut(dependentView)) {
                ...
                if (dependentView instanceof FloatingActionButton) {
                    ...
                    if (fab.getShowMotionSpec() == null) {
                        fab.setShowMotionSpecResource(C0633R.animator.mtrl_fab_show_motion_spec);
                    }
                    if (fab.getHideMotionSpec() == null) {
                        fab.setHideMotionSpecResource(C0633R.animator.mtrl_fab_hide_motion_spec);
                    }
