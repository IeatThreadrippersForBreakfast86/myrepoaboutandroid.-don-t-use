...
import com.google.android.material.C0633R;
...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.textInputStyle);
    }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0633R.styleable.TextInputLayout, defStyleAttr, DEF_STYLE_RES, C0633R.styleable.TextInputLayout_counterTextAppearance, C0633R.styleable.TextInputLayout_counterOverflowTextAppearance, C0633R.styleable.TextInputLayout_errorTextAppearance, C0633R.styleable.TextInputLayout_helperTextTextAppearance, C0633R.styleable.TextInputLayout_hintTextAppearance);
        this.startLayout = new StartCompoundLayout(this, a);
        this.hintEnabled = a.getBoolean(C0633R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0633R.styleable.TextInputLayout_android_hint));
        this.hintAnimationEnabled = a.getBoolean(C0633R.styleable.TextInputLayout_hintAnimationEnabled, true);
        this.expandedHintEnabled = a.getBoolean(C0633R.styleable.TextInputLayout_expandedHintEnabled, true);
        if (a.hasValue(C0633R.styleable.TextInputLayout_android_minEms)) {
            setMinEms(a.getInt(C0633R.styleable.TextInputLayout_android_minEms, -1));
        } else if (a.hasValue(C0633R.styleable.TextInputLayout_android_minWidth)) {
            setMinWidth(a.getDimensionPixelSize(C0633R.styleable.TextInputLayout_android_minWidth, -1));
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_android_maxEms)) {
            setMaxEms(a.getInt(C0633R.styleable.TextInputLayout_android_maxEms, -1));
        } else if (a.hasValue(C0633R.styleable.TextInputLayout_android_maxWidth)) {
            setMaxWidth(a.getDimensionPixelSize(C0633R.styleable.TextInputLayout_android_maxWidth, -1));
        }
        this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, DEF_STYLE_RES).build();
        this.boxLabelCutoutPaddingPx = context2.getResources().getDimensionPixelOffset(C0633R.dimen.mtrl_textinput_box_label_cutout_padding);
        this.boxCollapsedPaddingTopPx = a.getDimensionPixelOffset(C0633R.styleable.TextInputLayout_boxCollapsedPaddingTop, 0);
        this.boxStrokeWidthDefaultPx = a.getDimensionPixelSize(C0633R.styleable.TextInputLayout_boxStrokeWidth, context2.getResources().getDimensionPixelSize(C0633R.dimen.mtrl_textinput_box_stroke_width_default));
        this.boxStrokeWidthFocusedPx = a.getDimensionPixelSize(C0633R.styleable.TextInputLayout_boxStrokeWidthFocused, context2.getResources().getDimensionPixelSize(C0633R.dimen.mtrl_textinput_box_stroke_width_focused));
        this.boxStrokeWidthPx = this.boxStrokeWidthDefaultPx;
        float boxCornerRadiusTopStart = a.getDimension(C0633R.styleable.TextInputLayout_boxCornerRadiusTopStart, -1.0f);
        float boxCornerRadiusTopEnd = a.getDimension(C0633R.styleable.TextInputLayout_boxCornerRadiusTopEnd, -1.0f);
        float boxCornerRadiusBottomEnd = a.getDimension(C0633R.styleable.TextInputLayout_boxCornerRadiusBottomEnd, -1.0f);
        float boxCornerRadiusBottomStart = a.getDimension(C0633R.styleable.TextInputLayout_boxCornerRadiusBottomStart, -1.0f);
        ...
        ColorStateList filledBackgroundColorStateList = MaterialResources.getColorStateList(context2, a, C0633R.styleable.TextInputLayout_boxBackgroundColor);
        if (filledBackgroundColorStateList != null) {
            ...
            if (filledBackgroundColorStateList.isStateful()) {
                ...
                ColorStateList mtrlFilledBackgroundColorStateList = AppCompatResources.getColorStateList(context2, C0633R.color.mtrl_filled_background_color);
        ...
        if (a.hasValue(C0633R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0633R.styleable.TextInputLayout_android_textColorHint);
            this.focusedTextColor = colorStateList;
            this.defaultHintTextColor = colorStateList;
        }
        ColorStateList boxStrokeColorStateList = MaterialResources.getColorStateList(context2, a, C0633R.styleable.TextInputLayout_boxStrokeColor);
        this.focusedStrokeColor = a.getColor(C0633R.styleable.TextInputLayout_boxStrokeColor, 0);
        this.defaultStrokeColor = ContextCompat.getColor(context2, C0633R.color.mtrl_textinput_default_box_stroke_color);
        this.disabledColor = ContextCompat.getColor(context2, C0633R.color.mtrl_textinput_disabled_color);
        this.hoveredStrokeColor = ContextCompat.getColor(context2, C0633R.color.mtrl_textinput_hovered_box_stroke_color);
        if (boxStrokeColorStateList != null) {
            setBoxStrokeColorStateList(boxStrokeColorStateList);
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_boxStrokeErrorColor)) {
            setBoxStrokeErrorColor(MaterialResources.getColorStateList(context2, a, C0633R.styleable.TextInputLayout_boxStrokeErrorColor));
        }
        int hintAppearance = a.getResourceId(C0633R.styleable.TextInputLayout_hintTextAppearance, -1);
        if (hintAppearance != -1) {
            setHintTextAppearance(a.getResourceId(C0633R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.cursorColor = a.getColorStateList(C0633R.styleable.TextInputLayout_cursorColor);
        this.cursorErrorColor = a.getColorStateList(C0633R.styleable.TextInputLayout_cursorErrorColor);
        int errorTextAppearance = a.getResourceId(C0633R.styleable.TextInputLayout_errorTextAppearance, 0);
        CharSequence errorContentDescription = a.getText(C0633R.styleable.TextInputLayout_errorContentDescription);
        int errorAccessibilityLiveRegion = a.getInt(C0633R.styleable.TextInputLayout_errorAccessibilityLiveRegion, 1);
        boolean errorEnabled = a.getBoolean(C0633R.styleable.TextInputLayout_errorEnabled, false);
        int helperTextTextAppearance = a.getResourceId(C0633R.styleable.TextInputLayout_helperTextTextAppearance, 0);
        boolean helperTextEnabled = a.getBoolean(C0633R.styleable.TextInputLayout_helperTextEnabled, false);
        CharSequence helperText = a.getText(C0633R.styleable.TextInputLayout_helperText);
        int placeholderTextAppearance = a.getResourceId(C0633R.styleable.TextInputLayout_placeholderTextAppearance, 0);
        CharSequence placeholderText = a.getText(C0633R.styleable.TextInputLayout_placeholderText);
        boolean counterEnabled = a.getBoolean(C0633R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0633R.styleable.TextInputLayout_counterMaxLength, -1));
        this.counterTextAppearance = a.getResourceId(C0633R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.counterOverflowTextAppearance = a.getResourceId(C0633R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        setBoxBackgroundMode(a.getInt(C0633R.styleable.TextInputLayout_boxBackgroundMode, 0));
        ...
        if (a.hasValue(C0633R.styleable.TextInputLayout_errorTextColor)) {
            setErrorTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_errorTextColor));
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_helperTextTextColor)) {
            setHelperTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_helperTextTextColor));
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_hintTextColor)) {
            setHintTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_hintTextColor));
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_counterTextColor)) {
            setCounterTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_counterTextColor));
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_counterOverflowTextColor)) {
            setCounterOverflowTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_counterOverflowTextColor));
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_placeholderTextColor)) {
            setPlaceholderTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_placeholderTextColor));
        }
        this.endLayout = new EndCompoundLayout(this, a);
        boolean enabled = a.getBoolean(C0633R.styleable.TextInputLayout_android_enabled, true);
        a.recycle();
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        int rippleColor = MaterialColors.getColor(this.editText, C0633R.attr.colorControlHighlight);
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable boxBackground, int rippleColor, int[][] states) {
        int surfaceColor = MaterialColors.getColor(context, C0633R.attr.colorSurface, LOG_TAG);
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean roundedTopCorners) throws Resources.NotFoundException {
        float elevation;
        float cornerRadius = getResources().getDimensionPixelOffset(C0633R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (this.editText instanceof MaterialAutoCompleteTextView) {
            ...
            elevation = getResources().getDimensionPixelOffset(C0633R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int verticalPadding = getResources().getDimensionPixelOffset(C0633R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0633R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0633R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            ViewCompat.setPaddingRelative(this.editText, ViewCompat.getPaddingStart(this.editText), getResources().getDimensionPixelSize(C0633R.dimen.material_filled_edittext_font_2_0_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0633R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            ViewCompat.setPaddingRelative(this.editText, ViewCompat.getPaddingStart(this.editText), getResources().getDimensionPixelSize(C0633R.dimen.material_filled_edittext_font_1_3_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0633R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.counterEnabled != enabled) {
            if (!enabled) {
                ...
                this.counterView.setId(C0633R.id.textinput_counter);
                if (this.typeface != null) {
                    this.counterView.setTypeface(this.typeface);
                }
                this.counterView.setMaxLines(1);
                this.indicatorViewController.addIndicator(this.counterView, 2);
                MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(C0633R.dimen.mtrl_textinput_counter_margin_start));
    ...
    void updateCounter(Editable text) {
        ...
        if (this.counterMaxLength == -1) {
            ...
            this.counterView.setText(bidiFormatter.unicodeWrap(getContext().getString(C0633R.string.character_counter_pattern, Integer.valueOf(length), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView counterView, int length, int counterMaxLength, boolean counterOverflowed) {
        ...
        if (counterOverflowed) {
            i = C0633R.string.character_counter_overflowed_content_description;
        } else {
            i = C0633R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence placeholderText) {
        if (this.placeholderTextView == null) {
            ...
            this.placeholderTextView.setId(C0633R.id.textinput_placeholder);
    ...
    private Fade createPlaceholderFadeTransition() {
        ...
        placeholderFadeTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0633R.attr.motionDurationShort2, DEFAULT_PLACEHOLDER_FADE_DURATION));
        placeholderFadeTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0633R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
    ...
    void setTextAppearanceCompatWithErrorFallback(TextView textView, int textAppearance) {
        ...
        if (useDefaultColor) {
            TextViewCompat.setTextAppearance(textView, C0633R.style.TextAppearance_AppCompat_Caption);
            textView.setTextColor(ContextCompat.getColor(getContext(), C0633R.color.design_error));
        }
    }
    ...
    private int calculateBoxBackgroundColor() {
        ...
        if (this.boxBackgroundMode == 1) {
            int surfaceLayerColor = MaterialColors.getColor(this, C0633R.attr.colorSurface, 0);
    ...
    private void updateCursorColor() {
        ...
        if (this.cursorColor != null) {
            ...
            color = MaterialColors.getColorStateListOrNull(getContext(), C0633R.attr.colorControlActivated);
        }
    ...
    void animateToExpansionFraction(float target) {
        ...
        if (this.animator == null) {
            ...
            this.animator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0633R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0633R.attr.motionDurationMedium4, LABEL_SCALE_ANIMATION_DURATION));
