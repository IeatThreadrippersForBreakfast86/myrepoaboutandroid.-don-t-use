...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    ClearTextEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0633R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0633R.attr.motionDurationShort3, DEFAULT_ANIMATION_SCALE_DURATION);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endLayout.getContext(), C0633R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endLayout.getContext(), C0633R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    int getIconDrawableResId() {
        return C0633R.drawable.mtrl_ic_cancel;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C0633R.string.clear_text_end_icon_content_description;
    }
