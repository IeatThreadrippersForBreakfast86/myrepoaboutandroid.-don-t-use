...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputView) {
        ...
        this.captionTranslationYPx = this.context.getResources().getDimensionPixelSize(C0633R.dimen.design_textinput_caption_translate_y);
        this.captionTranslationYAnimationDuration = MotionUtils.resolveThemeDuration(this.context, C0633R.attr.motionDurationShort4, DEFAULT_CAPTION_TRANSLATION_Y_ANIMATION_DURATION);
        this.captionFadeInAnimationDuration = MotionUtils.resolveThemeDuration(this.context, C0633R.attr.motionDurationMedium4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(this.context, C0633R.attr.motionDurationShort4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        this.captionTranslationYAnimationInterpolator = MotionUtils.resolveThemeInterpolator(this.context, C0633R.attr.motionEasingEmphasizedDecelerateInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(this.context, C0633R.attr.motionEasingEmphasizedDecelerateInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        this.captionFadeOutAnimationInterpolator = MotionUtils.resolveThemeInterpolator(this.context, C0633R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    }
    ...
    void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            ...
            ViewCompat.setPaddingRelative(this.indicatorArea, getIndicatorPadding(isFontScaleLarge, C0633R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.getPaddingStart(editText)), getIndicatorPadding(isFontScaleLarge, C0633R.dimen.material_helper_text_font_1_3_padding_top, this.context.getResources().getDimensionPixelSize(C0633R.dimen.material_helper_text_default_padding_top)), getIndicatorPadding(isFontScaleLarge, C0633R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.getPaddingEnd(editText)), 0);
        }
    }
    ...
    void setErrorEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            this.errorView.setId(C0633R.id.textinput_error);
    ...
    void setHelperTextEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            this.helperTextView.setId(C0633R.id.textinput_helper_text);
