...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    DropdownMenuEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0633R.attr.motionDurationShort3, 67);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0633R.attr.motionDurationShort3, 50);
    ...
    int getIconDrawableResId() {
        return IS_LOLLIPOP ? C0633R.drawable.mtrl_dropdown_arrow : C0633R.drawable.mtrl_ic_arrow_drop_down;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C0633R.string.exposed_dropdown_menu_content_description;
    }
