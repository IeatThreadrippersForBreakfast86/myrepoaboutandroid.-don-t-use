...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.editTextStyle);
    }
    ...
    public TextInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0633R.styleable.TextInputEditText, defStyleAttr, C0633R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(attributes.getBoolean(C0633R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
        attributes.recycle();
    }
