...
class EndCompoundLayout extends LinearLayout {
    ...
    EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray a) {
        ...
        this.errorIconView = createIconView(this, layoutInflater, C0633R.id.text_input_error_icon);
        this.endIconView = createIconView(this.endIconFrame, layoutInflater, C0633R.id.text_input_end_icon);
    ...
    private CheckableImageButton createIconView(ViewGroup root, LayoutInflater inflater, int id) {
        CheckableImageButton iconView = (CheckableImageButton) inflater.inflate(C0633R.layout.design_text_input_end_icon, root, false);
        iconView.setId(id);
    ...
    private void initErrorIconView(TintTypedArray a) {
        if (a.hasValue(C0633R.styleable.TextInputLayout_errorIconTint)) {
            this.errorIconTintList = MaterialResources.getColorStateList(getContext(), a, C0633R.styleable.TextInputLayout_errorIconTint);
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_errorIconTintMode)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(a.getInt(C0633R.styleable.TextInputLayout_errorIconTintMode, -1), null);
        }
        if (a.hasValue(C0633R.styleable.TextInputLayout_errorIconDrawable)) {
            setErrorIconDrawable(a.getDrawable(C0633R.styleable.TextInputLayout_errorIconDrawable));
        }
        this.errorIconView.setContentDescription(getResources().getText(C0633R.string.error_icon_content_description));
    ...
    private void initEndIconView(TintTypedArray tintTypedArray) {
        if (!tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_endIconTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C0633R.styleable.TextInputLayout_endIconTint);
            }
            if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_endIconTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C0633R.styleable.TextInputLayout_endIconTintMode, -1), null);
            }
        }
        if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_endIconMode)) {
            setEndIconMode(tintTypedArray.getInt(C0633R.styleable.TextInputLayout_endIconMode, 0));
            if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_endIconContentDescription)) {
                setEndIconContentDescription(tintTypedArray.getText(C0633R.styleable.TextInputLayout_endIconContentDescription));
            }
            setEndIconCheckable(tintTypedArray.getBoolean(C0633R.styleable.TextInputLayout_endIconCheckable, true));
        } else if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_passwordToggleTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C0633R.styleable.TextInputLayout_passwordToggleTint);
            }
            if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_passwordToggleTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C0633R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
            }
            setEndIconMode(tintTypedArray.getBoolean(C0633R.styleable.TextInputLayout_passwordToggleEnabled, false) ? 1 : 0);
            setEndIconContentDescription(tintTypedArray.getText(C0633R.styleable.TextInputLayout_passwordToggleContentDescription));
        }
        setEndIconMinSize(tintTypedArray.getDimensionPixelSize(C0633R.styleable.TextInputLayout_endIconMinSize, getResources().getDimensionPixelSize(C0633R.dimen.mtrl_min_touch_target_size)));
        if (tintTypedArray.hasValue(C0633R.styleable.TextInputLayout_endIconScaleType)) {
            setEndIconScaleType(IconHelper.convertScaleType(tintTypedArray.getInt(C0633R.styleable.TextInputLayout_endIconScaleType, -1)));
        }
    }

    private void initSuffixTextView(TintTypedArray a) {
        this.suffixTextView.setVisibility(8);
        this.suffixTextView.setId(C0633R.id.textinput_suffix_text);
        ...
        setSuffixTextAppearance(a.getResourceId(C0633R.styleable.TextInputLayout_suffixTextAppearance, 0));
        if (a.hasValue(C0633R.styleable.TextInputLayout_suffixTextColor)) {
            setSuffixTextColor(a.getColorStateList(C0633R.styleable.TextInputLayout_suffixTextColor));
        }
        setSuffixText(a.getText(C0633R.styleable.TextInputLayout_suffixText));
    }
    ...
    void updateSuffixTextViewPadding() {
        ...
        ViewCompat.setPaddingRelative(this.suffixTextView, getContext().getResources().getDimensionPixelSize(C0633R.dimen.material_input_text_to_prefix_suffix_padding), this.textInputLayout.editText.getPaddingTop(), endPadding, this.textInputLayout.editText.getPaddingBottom());
    }
    ...
    private static class EndIconDelegates {
        ...
        EndIconDelegates(EndCompoundLayout endLayout, TintTypedArray a) {
            ...
            this.customEndIconDrawableId = a.getResourceId(C0633R.styleable.TextInputLayout_endIconDrawable, 0);
            this.passwordIconDrawableId = a.getResourceId(C0633R.styleable.TextInputLayout_passwordToggleDrawable, 0);
        }
