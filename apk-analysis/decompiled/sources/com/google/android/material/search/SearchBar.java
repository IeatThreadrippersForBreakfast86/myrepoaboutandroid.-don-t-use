...
public class SearchBar extends Toolbar {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Material3_SearchBar;
    ...
    /* synthetic */ void m247lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean enabled) {
    ...
    public SearchBar(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.materialSearchBarStyle);
    }
    ...
    public SearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda1
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m247lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.SearchBar, defStyleAttr, DEF_STYLE_RES, new int[0]);
        ShapeAppearanceModel shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, DEF_STYLE_RES).build();
        int backgroundColor = a.getColor(C0633R.styleable.SearchBar_backgroundTint, 0);
        float elevation = a.getDimension(C0633R.styleable.SearchBar_elevation, 0.0f);
        this.defaultMarginsEnabled = a.getBoolean(C0633R.styleable.SearchBar_defaultMarginsEnabled, true);
        this.defaultScrollFlagsEnabled = a.getBoolean(C0633R.styleable.SearchBar_defaultScrollFlagsEnabled, true);
        boolean hideNavigationIcon = a.getBoolean(C0633R.styleable.SearchBar_hideNavigationIcon, false);
        this.forceDefaultNavigationOnClickListener = a.getBoolean(C0633R.styleable.SearchBar_forceDefaultNavigationOnClickListener, false);
        this.tintNavigationIcon = a.getBoolean(C0633R.styleable.SearchBar_tintNavigationIcon, true);
        if (a.hasValue(C0633R.styleable.SearchBar_navigationIconTint)) {
            this.navigationIconTint = Integer.valueOf(a.getColor(C0633R.styleable.SearchBar_navigationIconTint, -1));
        }
        int textAppearanceResId = a.getResourceId(C0633R.styleable.SearchBar_android_textAppearance, -1);
        String text = a.getString(C0633R.styleable.SearchBar_android_text);
        String hint = a.getString(C0633R.styleable.SearchBar_android_hint);
        float strokeWidth = a.getDimension(C0633R.styleable.SearchBar_strokeWidth, -1.0f);
        int strokeColor = a.getColor(C0633R.styleable.SearchBar_strokeColor, 0);
        a.recycle();
        ...
        setClickable(true);
        setFocusable(true);
        LayoutInflater.from(context2).inflate(C0633R.layout.mtrl_search_bar, this);
        this.layoutInflated = true;
        this.textView = (TextView) findViewById(C0633R.id.open_search_bar_text_view);
    ...
    private void initTextView(int textAppearanceResId, String text, String hint) {
        ...
        if (getNavigationIcon() == null) {
            MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(C0633R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearance, int backgroundColor, float elevation, float strokeWidth, int strokeColor) {
        ...
        int rippleColor = MaterialColors.getColor(this, C0633R.attr.colorControlHighlight);
    ...
    private Drawable maybeTintNavigationIcon(Drawable navigationIcon) {
        ...
        if (this.navigationIconTint != null) {
            ...
            if (navigationIcon == this.defaultNavigationIcon) {
                navigationIconColorAttr = C0633R.attr.colorOnSurfaceVariant;
            } else {
                navigationIconColorAttr = C0633R.attr.colorOnSurface;
            }
    ...
    private void setDefaultMargins() throws Resources.NotFoundException {
        if (this.defaultMarginsEnabled && (getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int marginHorizontal = resources.getDimensionPixelSize(C0633R.dimen.m3_searchbar_margin_horizontal);
    ...
    protected int getDefaultMarginVerticalResource() {
        return C0633R.dimen.m3_searchbar_margin_vertical;
    }

    protected int getDefaultNavigationIconResource() {
        return C0633R.drawable.ic_search_black_24;
    }
