...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0633R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0633R.style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = a.getDrawable(C0633R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
