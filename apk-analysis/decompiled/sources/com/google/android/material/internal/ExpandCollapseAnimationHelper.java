...
public class ExpandCollapseAnimationHelper {
    ...
    private Animator getExpandCollapseAnimator(boolean expand) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.internal.ExpandCollapseAnimationHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m105xeb41e2ac(bounds, valueAnimator);
            }
        });
        ...
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m106of(expand, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animator;
    }

    /* renamed from: lambda$getExpandCollapseAnimator$0$com-google-android-material-internal-ExpandCollapseAnimationHelper */
    /* synthetic */ void m105xeb41e2ac(Rect bounds, ValueAnimator valueAnimator) {
    ...
    private Animator getExpandedViewChildrenAlphaAnimator(boolean expand) {
        ...
        animator.setDuration(this.duration);
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m106of(expand, AnimationUtils.LINEAR_INTERPOLATOR));
        return animator;
    }
