...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.AppBarLayout, defStyleAttr, DEF_STYLE_RES, new int[0]);
        ViewCompat.setBackground(this, a.getDrawable(C0633R.styleable.AppBarLayout_android_background));
        ColorStateList liftOnScrollColor = MaterialResources.getColorStateList(context2, a, C0633R.styleable.AppBarLayout_liftOnScrollColor);
        ...
        this.liftOnScrollColorDuration = MotionUtils.resolveThemeDuration(context2, C0633R.attr.motionDurationMedium2, getResources().getInteger(C0633R.integer.app_bar_elevation_anim_duration));
        this.liftOnScrollColorInterpolator = MotionUtils.resolveThemeInterpolator(context2, C0633R.attr.motionEasingStandardInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        if (a.hasValue(C0633R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0633R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (a.hasValue(C0633R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, a.getDimensionPixelSize(C0633R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0633R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0633R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0633R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0633R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.appBarElevation = getResources().getDimension(C0633R.dimen.design_appbar_elevation);
        this.liftOnScroll = a.getBoolean(C0633R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = a.getResourceId(C0633R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(a.getDrawable(C0633R.styleable.AppBarLayout_statusBarForeground));
        a.recycle();
    ...
    private void initializeLiftOnScrollWithColor(final MaterialShapeDrawable background, final ColorStateList originalBackgroundColor, final ColorStateList liftOnScrollColor) {
        final Integer colorSurface = MaterialColors.getColorOrNull(getContext(), C0633R.attr.colorSurface);
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m53x91f594d8(originalBackgroundColor, liftOnScrollColor, background, colorSurface, valueAnimator);
            }
        };
    ...
    /* synthetic */ void m53x91f594d8(ColorStateList originalBackgroundColor, ColorStateList liftOnScrollColor, MaterialShapeDrawable background, Integer colorSurface, ValueAnimator valueAnimator) {
    ...
    private void initializeLiftOnScrollWithElevation(Context context, final MaterialShapeDrawable background) {
        ...
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m54x84b6053(background, valueAnimator);
            }
        };
        ViewCompat.setBackground(this, background);
    }
    ...
    /* synthetic */ void m54x84b6053(MaterialShapeDrawable background, ValueAnimator valueAnimator) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0633R.attr.state_liftable : -C0633R.attr.state_liftable;
        extraStates[1] = (this.liftable && this.lifted) ? C0633R.attr.state_lifted : -C0633R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0633R.attr.state_collapsible : -C0633R.attr.state_collapsible;
        extraStates[3] = (this.liftable && this.lifted) ? C0633R.attr.state_collapsed : -C0633R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.scrollFlags = 1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0633R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0633R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int scrollEffectInt = a.getInt(C0633R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0);
            setScrollEffect(scrollEffectInt);
            if (a.hasValue(C0633R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0633R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0633R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0633R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
