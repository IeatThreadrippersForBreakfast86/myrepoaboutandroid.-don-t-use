...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float elevation) throws Resources.NotFoundException {
        int dur = view.getResources().getInteger(C0633R.integer.app_bar_elevation_anim_duration);
        StateListAnimator sla = new StateListAnimator();
        sla.addState(new int[]{R.attr.state_enabled, C0633R.attr.state_liftable, -C0633R.attr.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(dur));
