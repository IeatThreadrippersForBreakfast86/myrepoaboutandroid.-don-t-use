...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        this.badgeRadius = a.getDimensionPixelSize(C0633R.styleable.Badge_badgeRadius, -1);
        this.horizontalInset = context.getResources().getDimensionPixelSize(C0633R.dimen.mtrl_badge_horizontal_edge_offset);
        this.horizontalInsetWithText = context.getResources().getDimensionPixelSize(C0633R.dimen.mtrl_badge_text_horizontal_edge_offset);
        this.badgeWithTextRadius = a.getDimensionPixelSize(C0633R.styleable.Badge_badgeWithTextRadius, -1);
        this.badgeWidth = a.getDimension(C0633R.styleable.Badge_badgeWidth, res.getDimension(C0633R.dimen.m3_badge_size));
        this.badgeWithTextWidth = a.getDimension(C0633R.styleable.Badge_badgeWithTextWidth, res.getDimension(C0633R.dimen.m3_badge_with_text_size));
        this.badgeHeight = a.getDimension(C0633R.styleable.Badge_badgeHeight, res.getDimension(C0633R.dimen.m3_badge_size));
        this.badgeWithTextHeight = a.getDimension(C0633R.styleable.Badge_badgeWithTextHeight, res.getDimension(C0633R.dimen.m3_badge_with_text_size));
        boolean z = true;
        this.offsetAlignmentMode = a.getInt(C0633R.styleable.Badge_offsetAlignmentMode, 1);
        this.currentState.alpha = storedState.alpha == -2 ? 255 : storedState.alpha;
        if (storedState.number == -2) {
            if (a.hasValue(C0633R.styleable.Badge_number)) {
                this.currentState.number = a.getInt(C0633R.styleable.Badge_number, 0);
            } else {
        ...
        if (storedState.text == null) {
            if (a.hasValue(C0633R.styleable.Badge_badgeText)) {
                this.currentState.text = a.getString(C0633R.styleable.Badge_badgeText);
            }
        } else {
        ...
        if (storedState.contentDescriptionNumberless == null) {
            string = context.getString(C0633R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (storedState.contentDescriptionQuantityStrings == 0) {
            i = C0633R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (storedState.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i2 = C0633R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (storedState.maxCharacterCount == -2) {
            i3 = a.getInt(C0633R.styleable.Badge_maxCharacterCount, -2);
        } else {
        ...
        if (storedState.maxNumber == -2) {
            i4 = a.getInt(C0633R.styleable.Badge_maxNumber, -2);
        } else {
        ...
        if (storedState.badgeShapeAppearanceResId == null) {
            iIntValue = a.getResourceId(C0633R.styleable.Badge_badgeShapeAppearance, C0633R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (storedState.badgeShapeAppearanceOverlayResId == null) {
            iIntValue2 = a.getResourceId(C0633R.styleable.Badge_badgeShapeAppearanceOverlay, 0);
        } else {
        ...
        if (storedState.badgeWithTextShapeAppearanceResId == null) {
            iIntValue3 = a.getResourceId(C0633R.styleable.Badge_badgeWithTextShapeAppearance, C0633R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (storedState.badgeWithTextShapeAppearanceOverlayResId == null) {
            iIntValue4 = a.getResourceId(C0633R.styleable.Badge_badgeWithTextShapeAppearanceOverlay, 0);
        } else {
        ...
        if (storedState.backgroundColor == null) {
            iIntValue5 = readColorFromAttributes(context, a, C0633R.styleable.Badge_backgroundColor);
        } else {
        ...
        if (storedState.badgeTextAppearanceResId == null) {
            iIntValue6 = a.getResourceId(C0633R.styleable.Badge_badgeTextAppearance, C0633R.style.TextAppearance_MaterialComponents_Badge);
        } else {
        ...
        if (storedState.badgeTextColor == null) {
            if (!a.hasValue(C0633R.styleable.Badge_badgeTextColor)) {
                ...
                this.currentState.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, a, C0633R.styleable.Badge_badgeTextColor));
            }
        } else {
        ...
        if (storedState.badgeGravity == null) {
            iIntValue7 = a.getInt(C0633R.styleable.Badge_badgeGravity, 8388661);
        } else {
        ...
        if (storedState.badgeHorizontalPadding == null) {
            iIntValue8 = a.getDimensionPixelSize(C0633R.styleable.Badge_badgeWidePadding, res.getDimensionPixelSize(C0633R.dimen.mtrl_badge_long_text_horizontal_padding));
        } else {
        ...
        if (storedState.badgeVerticalPadding == null) {
            iIntValue9 = a.getDimensionPixelSize(C0633R.styleable.Badge_badgeVerticalPadding, res.getDimensionPixelSize(C0633R.dimen.m3_badge_with_text_vertical_padding));
        } else {
        ...
        if (storedState.horizontalOffsetWithoutText == null) {
            iIntValue10 = a.getDimensionPixelOffset(C0633R.styleable.Badge_horizontalOffset, 0);
        } else {
        ...
        if (storedState.verticalOffsetWithoutText == null) {
            iIntValue11 = a.getDimensionPixelOffset(C0633R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (storedState.horizontalOffsetWithText == null) {
            iIntValue12 = a.getDimensionPixelOffset(C0633R.styleable.Badge_horizontalOffsetWithText, this.currentState.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.verticalOffsetWithText == null) {
            iIntValue13 = a.getDimensionPixelOffset(C0633R.styleable.Badge_verticalOffsetWithText, this.currentState.verticalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.largeFontVerticalOffsetAdjustment == null) {
            iIntValue14 = a.getDimensionPixelOffset(C0633R.styleable.Badge_largeFontVerticalOffsetAdjustment, 0);
        } else {
        ...
        if (storedState.autoAdjustToWithinGrandparentBounds == null) {
            zBooleanValue = a.getBoolean(C0633R.styleable.Badge_autoAdjustToWithinGrandparentBounds, false);
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int badgeResId, int defStyleAttr, int defStyleRes) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, attrs, C0633R.styleable.Badge, defStyleAttr, style, new int[0]);
    }
