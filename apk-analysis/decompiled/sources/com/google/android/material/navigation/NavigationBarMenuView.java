...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        if (isInEditMode()) {
            ...
            this.set.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0633R.attr.motionDurationMedium4, getResources().getInteger(C0633R.integer.material_motion_duration_long_1)));
            this.set.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0633R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
