...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.navigationViewStyle);
    }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0633R.styleable.NavigationView, defStyleAttr, DEF_STYLE_RES, new int[0]);
        if (a.hasValue(C0633R.styleable.NavigationView_android_background)) {
            ViewCompat.setBackground(this, a.getDrawable(C0633R.styleable.NavigationView_android_background));
        }
        this.drawerLayoutCornerSize = a.getDimensionPixelSize(C0633R.styleable.NavigationView_drawerLayoutCornerSize, 0);
        ...
        this.drawerLayoutCornerSizeBackAnimationMax = getResources().getDimensionPixelSize(C0633R.dimen.m3_navigation_drawer_layout_corner_size);
        ...
        if (a.hasValue(C0633R.styleable.NavigationView_elevation)) {
            setElevation(a.getDimensionPixelSize(C0633R.styleable.NavigationView_elevation, 0));
        }
        setFitsSystemWindows(a.getBoolean(C0633R.styleable.NavigationView_android_fitsSystemWindows, false));
        this.maxWidth = a.getDimensionPixelSize(C0633R.styleable.NavigationView_android_maxWidth, 0);
        ColorStateList subheaderColor = a.hasValue(C0633R.styleable.NavigationView_subheaderColor) ? a.getColorStateList(C0633R.styleable.NavigationView_subheaderColor) : null;
        int subheaderTextAppearance = a.hasValue(C0633R.styleable.NavigationView_subheaderTextAppearance) ? a.getResourceId(C0633R.styleable.NavigationView_subheaderTextAppearance, 0) : 0;
        if (subheaderTextAppearance == 0 && subheaderColor == null) {
            subheaderColor = createDefaultColorStateList(R.attr.textColorSecondary);
        }
        if (a.hasValue(C0633R.styleable.NavigationView_itemIconTint)) {
            itemIconTint = a.getColorStateList(C0633R.styleable.NavigationView_itemIconTint);
        } else {
            itemIconTint = createDefaultColorStateList(R.attr.textColorSecondary);
        }
        int textAppearance = a.hasValue(C0633R.styleable.NavigationView_itemTextAppearance) ? a.getResourceId(C0633R.styleable.NavigationView_itemTextAppearance, 0) : 0;
        boolean textAppearanceActiveBoldEnabled = a.getBoolean(C0633R.styleable.NavigationView_itemTextAppearanceActiveBoldEnabled, true);
        if (a.hasValue(C0633R.styleable.NavigationView_itemIconSize)) {
            setItemIconSize(a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemIconSize, 0));
        }
        ColorStateList itemTextColor = a.hasValue(C0633R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C0633R.styleable.NavigationView_itemTextColor) : null;
        if (textAppearance == 0 && itemTextColor == null) {
            itemTextColor = createDefaultColorStateList(R.attr.textColorPrimary);
        }
        Drawable itemBackground = a.getDrawable(C0633R.styleable.NavigationView_itemBackground);
        if (itemBackground == null && hasShapeAppearance(a)) {
            itemBackground = createDefaultItemBackground(a);
            ColorStateList itemRippleColor = MaterialResources.getColorStateList(context2, a, C0633R.styleable.NavigationView_itemRippleColor);
        ...
        if (a.hasValue(C0633R.styleable.NavigationView_itemHorizontalPadding)) {
            int itemHorizontalPadding = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemHorizontalPadding, 0);
            setItemHorizontalPadding(itemHorizontalPadding);
        }
        int itemHorizontalPadding2 = C0633R.styleable.NavigationView_itemVerticalPadding;
        if (!a.hasValue(itemHorizontalPadding2)) {
            i = 0;
        } else {
            i = 0;
            int itemVerticalPadding = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemVerticalPadding, 0);
            setItemVerticalPadding(itemVerticalPadding);
        }
        int dividerInsetStart = a.getDimensionPixelSize(C0633R.styleable.NavigationView_dividerInsetStart, i);
        setDividerInsetStart(dividerInsetStart);
        int dividerInsetEnd = a.getDimensionPixelSize(C0633R.styleable.NavigationView_dividerInsetEnd, i);
        setDividerInsetEnd(dividerInsetEnd);
        int subheaderInsetStart = a.getDimensionPixelSize(C0633R.styleable.NavigationView_subheaderInsetStart, i);
        setSubheaderInsetStart(subheaderInsetStart);
        int subheaderInsetEnd = a.getDimensionPixelSize(C0633R.styleable.NavigationView_subheaderInsetEnd, i);
        setSubheaderInsetEnd(subheaderInsetEnd);
        setTopInsetScrimEnabled(a.getBoolean(C0633R.styleable.NavigationView_topInsetScrimEnabled, this.topInsetScrimEnabled));
        setBottomInsetScrimEnabled(a.getBoolean(C0633R.styleable.NavigationView_bottomInsetScrimEnabled, this.bottomInsetScrimEnabled));
        int itemIconPadding = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemIconPadding, 0);
        setItemMaxLines(a.getInt(C0633R.styleable.NavigationView_itemMaxLines, 1));
        ...
        if (a.hasValue(C0633R.styleable.NavigationView_menu)) {
            i2 = 0;
            inflateMenu(a.getResourceId(C0633R.styleable.NavigationView_menu, 0));
        } else {
            i2 = 0;
        }
        if (a.hasValue(C0633R.styleable.NavigationView_headerLayout)) {
            inflateHeaderView(a.getResourceId(C0633R.styleable.NavigationView_headerLayout, i2));
        }
        a.recycle();
    ...
    private boolean hasShapeAppearance(TintTypedArray a) {
        return a.hasValue(C0633R.styleable.NavigationView_itemShapeAppearance) || a.hasValue(C0633R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private Drawable createDefaultItemBackground(TintTypedArray a) {
        ColorStateList fillColor = MaterialResources.getColorStateList(getContext(), a, C0633R.styleable.NavigationView_itemShapeFillColor);
    ...
    private Drawable createDefaultItemDrawable(TintTypedArray a, ColorStateList fillColor) {
        int shapeAppearanceResId = a.getResourceId(C0633R.styleable.NavigationView_itemShapeAppearance, 0);
        int shapeAppearanceOverlayResId = a.getResourceId(C0633R.styleable.NavigationView_itemShapeAppearanceOverlay, 0);
        ...
        int insetLeft = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemShapeInsetStart, 0);
        int insetTop = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemShapeInsetTop, 0);
        int insetRight = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemShapeInsetEnd, 0);
        int insetBottom = a.getDimensionPixelSize(C0633R.styleable.NavigationView_itemShapeInsetBottom, 0);
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0036R.attr.colorPrimary, value, true)) {
            return null;
        }
