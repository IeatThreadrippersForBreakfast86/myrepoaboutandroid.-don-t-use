...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C0633R.id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C0633R.id.navigation_bar_item_active_indicator_view);
        this.icon = (ImageView) findViewById(C0633R.id.navigation_bar_item_icon_view);
        this.labelGroup = (ViewGroup) findViewById(C0633R.id.navigation_bar_item_labels_group);
        this.smallLabel = (TextView) findViewById(C0633R.id.navigation_bar_item_small_label_view);
        this.largeLabel = (TextView) findViewById(C0633R.id.navigation_bar_item_large_label_view);
        setBackgroundResource(getItemBackgroundResId());
        this.itemPaddingTop = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
        this.itemPaddingBottom = this.labelGroup.getPaddingBottom();
        this.activeIndicatorLabelPadding = getResources().getDimensionPixelSize(C0633R.dimen.m3_navigation_item_active_indicator_label_padding);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float newProgress) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0633R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0633R.attr.motionDurationLong2, getResources().getInteger(C0633R.integer.material_motion_duration_long_1)));
    ...
    protected int getItemBackgroundResId() {
        return C0633R.drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C0633R.dimen.mtrl_navigation_bar_item_default_margin;
    }
