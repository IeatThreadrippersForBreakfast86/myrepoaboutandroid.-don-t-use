...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws Resources.NotFoundException {
        ...
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0633R.styleable.NavigationBarView, defStyleAttr, defStyleRes, C0633R.styleable.NavigationBarView_itemTextAppearanceInactive, C0633R.styleable.NavigationBarView_itemTextAppearanceActive);
        ...
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_itemIconTint)) {
            this.menuView.setIconTintList(attributes.getColorStateList(C0633R.styleable.NavigationBarView_itemIconTint));
        } else {
            this.menuView.setIconTintList(this.menuView.createDefaultColorStateList(R.attr.textColorSecondary));
        }
        setItemIconSize(attributes.getDimensionPixelSize(C0633R.styleable.NavigationBarView_itemIconSize, getResources().getDimensionPixelSize(C0633R.dimen.mtrl_navigation_bar_item_default_icon_size)));
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_itemTextAppearanceInactive)) {
            setItemTextAppearanceInactive(attributes.getResourceId(C0633R.styleable.NavigationBarView_itemTextAppearanceInactive, 0));
        }
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_itemTextAppearanceActive)) {
            setItemTextAppearanceActive(attributes.getResourceId(C0633R.styleable.NavigationBarView_itemTextAppearanceActive, 0));
        }
        boolean isBold = attributes.getBoolean(C0633R.styleable.NavigationBarView_itemTextAppearanceActiveBoldEnabled, true);
        setItemTextAppearanceActiveBoldEnabled(isBold);
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_itemTextColor)) {
            setItemTextColor(attributes.getColorStateList(C0633R.styleable.NavigationBarView_itemTextColor));
        }
        ...
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_itemPaddingTop)) {
            setItemPaddingTop(attributes.getDimensionPixelSize(C0633R.styleable.NavigationBarView_itemPaddingTop, 0));
        }
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_itemPaddingBottom)) {
            setItemPaddingBottom(attributes.getDimensionPixelSize(C0633R.styleable.NavigationBarView_itemPaddingBottom, 0));
        }
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_activeIndicatorLabelPadding)) {
            setActiveIndicatorLabelPadding(attributes.getDimensionPixelSize(C0633R.styleable.NavigationBarView_activeIndicatorLabelPadding, 0));
        }
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_elevation)) {
            setElevation(attributes.getDimensionPixelSize(C0633R.styleable.NavigationBarView_elevation, 0));
        }
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context2, attributes, C0633R.styleable.NavigationBarView_backgroundTint);
        DrawableCompat.setTintList(getBackground().mutate(), backgroundTint);
        setLabelVisibilityMode(attributes.getInteger(C0633R.styleable.NavigationBarView_labelVisibilityMode, -1));
        int itemBackground = attributes.getResourceId(C0633R.styleable.NavigationBarView_itemBackground, 0);
        if (itemBackground != 0) {
            this.menuView.setItemBackgroundRes(itemBackground);
        } else {
            setItemRippleColor(MaterialResources.getColorStateList(context2, attributes, C0633R.styleable.NavigationBarView_itemRippleColor));
        }
        int activeIndicatorStyleResId = attributes.getResourceId(C0633R.styleable.NavigationBarView_itemActiveIndicatorStyle, 0);
        if (activeIndicatorStyleResId != 0) {
            setItemActiveIndicatorEnabled(true);
            TypedArray activeIndicatorAttributes = context2.obtainStyledAttributes(activeIndicatorStyleResId, C0633R.styleable.NavigationBarActiveIndicator);
            int itemActiveIndicatorWidth = activeIndicatorAttributes.getDimensionPixelSize(C0633R.styleable.NavigationBarActiveIndicator_android_width, 0);
            setItemActiveIndicatorWidth(itemActiveIndicatorWidth);
            int itemActiveIndicatorHeight = activeIndicatorAttributes.getDimensionPixelSize(C0633R.styleable.NavigationBarActiveIndicator_android_height, 0);
            setItemActiveIndicatorHeight(itemActiveIndicatorHeight);
            int itemActiveIndicatorMarginHorizontal = activeIndicatorAttributes.getDimensionPixelOffset(C0633R.styleable.NavigationBarActiveIndicator_marginHorizontal, 0);
            setItemActiveIndicatorMarginHorizontal(itemActiveIndicatorMarginHorizontal);
            ColorStateList itemActiveIndicatorColor = MaterialResources.getColorStateList(context2, activeIndicatorAttributes, C0633R.styleable.NavigationBarActiveIndicator_android_color);
            setItemActiveIndicatorColor(itemActiveIndicatorColor);
            int itemActiveIndicatorMarginHorizontal2 = C0633R.styleable.NavigationBarActiveIndicator_shapeAppearance;
        ...
        if (attributes.hasValue(C0633R.styleable.NavigationBarView_menu)) {
            inflateMenu(attributes.getResourceId(C0633R.styleable.NavigationBarView_menu, 0));
        }
        attributes.recycle();
