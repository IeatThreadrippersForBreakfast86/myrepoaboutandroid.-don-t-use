...
public class Scheme {
    ...
    private static Scheme lightFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f144a1.tone(40)).withOnPrimary(core.f144a1.tone(100)).withPrimaryContainer(core.f144a1.tone(90)).withOnPrimaryContainer(core.f144a1.tone(10)).withSecondary(core.f145a2.tone(40)).withOnSecondary(core.f145a2.tone(100)).withSecondaryContainer(core.f145a2.tone(90)).withOnSecondaryContainer(core.f145a2.tone(10)).withTertiary(core.f146a3.tone(40)).withOnTertiary(core.f146a3.tone(100)).withTertiaryContainer(core.f146a3.tone(90)).withOnTertiaryContainer(core.f146a3.tone(10)).withError(core.error.tone(40)).withOnError(core.error.tone(100)).withErrorContainer(core.error.tone(90)).withOnErrorContainer(core.error.tone(10)).withBackground(core.f147n1.tone(99)).withOnBackground(core.f147n1.tone(10)).withSurface(core.f147n1.tone(99)).withOnSurface(core.f147n1.tone(10)).withSurfaceVariant(core.f148n2.tone(90)).withOnSurfaceVariant(core.f148n2.tone(30)).withOutline(core.f148n2.tone(50)).withOutlineVariant(core.f148n2.tone(80)).withShadow(core.f147n1.tone(0)).withScrim(core.f147n1.tone(0)).withInverseSurface(core.f147n1.tone(20)).withInverseOnSurface(core.f147n1.tone(95)).withInversePrimary(core.f144a1.tone(80));
    }

    private static Scheme darkFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f144a1.tone(80)).withOnPrimary(core.f144a1.tone(20)).withPrimaryContainer(core.f144a1.tone(30)).withOnPrimaryContainer(core.f144a1.tone(90)).withSecondary(core.f145a2.tone(80)).withOnSecondary(core.f145a2.tone(20)).withSecondaryContainer(core.f145a2.tone(30)).withOnSecondaryContainer(core.f145a2.tone(90)).withTertiary(core.f146a3.tone(80)).withOnTertiary(core.f146a3.tone(20)).withTertiaryContainer(core.f146a3.tone(30)).withOnTertiaryContainer(core.f146a3.tone(90)).withError(core.error.tone(80)).withOnError(core.error.tone(20)).withErrorContainer(core.error.tone(30)).withOnErrorContainer(core.error.tone(80)).withBackground(core.f147n1.tone(10)).withOnBackground(core.f147n1.tone(90)).withSurface(core.f147n1.tone(10)).withOnSurface(core.f147n1.tone(90)).withSurfaceVariant(core.f148n2.tone(30)).withOnSurfaceVariant(core.f148n2.tone(80)).withOutline(core.f148n2.tone(60)).withOutlineVariant(core.f148n2.tone(30)).withShadow(core.f147n1.tone(0)).withScrim(core.f147n1.tone(0)).withInverseSurface(core.f147n1.tone(90)).withInverseOnSurface(core.f147n1.tone(20)).withInversePrimary(core.f144a1.tone(40));
    }
