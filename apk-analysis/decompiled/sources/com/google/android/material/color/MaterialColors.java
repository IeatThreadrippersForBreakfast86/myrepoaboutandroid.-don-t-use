...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int colorToHarmonize) {
        return harmonize(colorToHarmonize, getColor(context, C0633R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    static boolean isLightTheme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C0633R.attr.isLightTheme, true);
    }
