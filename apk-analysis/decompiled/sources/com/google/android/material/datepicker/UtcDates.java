...
class UtcDates {
    ...
    static String getDefaultTextInputHint(Resources res, SimpleDateFormat format) throws Resources.NotFoundException {
        ...
        String yearChar = res.getString(C0633R.string.mtrl_picker_text_input_year_abbr);
        String monthChar = res.getString(C0633R.string.mtrl_picker_text_input_month_abbr);
        String dayChar = res.getString(C0633R.string.mtrl_picker_text_input_day_abbr);
