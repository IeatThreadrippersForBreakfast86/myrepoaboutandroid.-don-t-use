...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, final OnSelectionChangedListener<Long> listener) throws Resources.NotFoundException {
        ...
        View root = layoutInflater.inflate(C0633R.layout.mtrl_picker_text_input_date, viewGroup, false);
        final TextInputLayout dateTextInput = (TextInputLayout) root.findViewById(C0633R.id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C0633R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (this.selectedItem == null) {
            return res.getString(C0633R.string.mtrl_picker_date_header_unselected);
        }
        String startString = DateStrings.getYearMonthDay(this.selectedItem.longValue());
        return res.getString(C0633R.string.mtrl_picker_date_header_selected, startString);
    }
    ...
    public String getSelectionContentDescription(Context context) throws Resources.NotFoundException {
        ...
        Resources res = context.getResources();
        if (this.selectedItem == null) {
            placeholder = res.getString(C0633R.string.mtrl_picker_announce_current_selection_none);
        } else {
            placeholder = DateStrings.getYearMonthDay(this.selectedItem.longValue());
        }
        return res.getString(C0633R.string.mtrl_picker_announce_current_selection, placeholder);
    }
    ...
    public int getDefaultTitleResId() {
        return C0633R.string.mtrl_picker_date_header_title;
    }
