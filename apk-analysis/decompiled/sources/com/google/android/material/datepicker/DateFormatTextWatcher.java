...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String formatHint, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints constraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0633R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m103x5657fb8e(formatHint);
            }
        };
    }

    /* renamed from: lambda$new$0$com-google-android-material-datepicker-DateFormatTextWatcher */
    /* synthetic */ void m103x5657fb8e(String formatHint) {
        TextInputLayout textLayout = this.textInputLayout;
        DateFormat df = this.dateFormat;
        Context context = textLayout.getContext();
        String invalidFormat = context.getString(C0633R.string.mtrl_picker_invalid_format);
        String useLine = String.format(context.getString(C0633R.string.mtrl_picker_invalid_format_use), sanitizeDateString(formatHint));
        String exampleLine = String.format(context.getString(C0633R.string.mtrl_picker_invalid_format_example), sanitizeDateString(df.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
