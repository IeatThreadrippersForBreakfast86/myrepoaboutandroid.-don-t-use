...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.tabStyle);
    }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.TabLayout, defStyleAttr, DEF_STYLE_RES, C0633R.styleable.TabLayout_tabTextAppearance);
        ...
        setSelectedTabIndicator(MaterialResources.getDrawable(context2, a, C0633R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorColor(a.getColor(C0633R.styleable.TabLayout_tabIndicatorColor, 0));
        this.slidingTabIndicator.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabIndicatorHeight, -1));
        setSelectedTabIndicatorGravity(a.getInt(C0633R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorAnimationMode(a.getInt(C0633R.styleable.TabLayout_tabIndicatorAnimationMode, 0));
        setTabIndicatorFullWidth(a.getBoolean(C0633R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        if (ThemeEnforcement.isMaterial3Theme(context2)) {
            this.defaultTabTextAppearance = C0633R.attr.textAppearanceTitleSmall;
        } else {
            this.defaultTabTextAppearance = C0633R.attr.textAppearanceButton;
        }
        this.tabTextAppearance = a.getResourceId(C0633R.styleable.TabLayout_tabTextAppearance, C0633R.style.TextAppearance_Design_Tab);
        TypedArray selectedTabTA = context2.obtainStyledAttributes(this.tabTextAppearance, C0036R.styleable.TextAppearance);
        try {
            this.tabTextSize = selectedTabTA.getDimensionPixelSize(C0036R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context2, selectedTabTA, C0036R.styleable.TextAppearance_android_textColor);
            selectedTabTA.recycle();
            if (a.hasValue(C0633R.styleable.TabLayout_tabSelectedTextAppearance)) {
                this.selectedTabTextAppearance = a.getResourceId(C0633R.styleable.TabLayout_tabSelectedTextAppearance, this.tabTextAppearance);
            }
            if (this.selectedTabTextAppearance != -1) {
                selectedTabTA = context2.obtainStyledAttributes(this.selectedTabTextAppearance, C0036R.styleable.TextAppearance);
                try {
                    this.selectedTabTextSize = selectedTabTA.getDimensionPixelSize(C0036R.styleable.TextAppearance_android_textSize, (int) this.tabTextSize);
                    ColorStateList selectedTabTextColor = MaterialResources.getColorStateList(context2, selectedTabTA, C0036R.styleable.TextAppearance_android_textColor);
            ...
            if (a.hasValue(C0633R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context2, a, C0633R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0633R.styleable.TabLayout_tabSelectedTextColor)) {
                int selected = a.getColor(C0633R.styleable.TabLayout_tabSelectedTextColor, 0);
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), selected);
            }
            int selected2 = C0633R.styleable.TabLayout_tabIconTint;
            this.tabIconTint = MaterialResources.getColorStateList(context2, a, selected2);
            this.tabIconTintMode = ViewUtils.parseTintMode(a.getInt(C0633R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context2, a, C0633R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = a.getInt(C0633R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.tabIndicatorTimeInterpolator = MotionUtils.resolveThemeInterpolator(context2, C0633R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            this.requestedTabMinWidth = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = a.getResourceId(C0633R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = a.getDimensionPixelSize(C0633R.styleable.TabLayout_tabContentStart, 0);
            this.mode = a.getInt(C0633R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = a.getInt(C0633R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = a.getBoolean(C0633R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = a.getBoolean(C0633R.styleable.TabLayout_tabUnboundedRipple, false);
            a.recycle();
            Resources res = getResources();
            this.tabTextMultiLineSize = res.getDimensionPixelSize(C0633R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = res.getDimensionPixelSize(C0633R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
        }
    }
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            infoCompat.setRoleDescription(getResources().getString(C0633R.string.item_view_role_description));
        }
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            this.iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0633R.layout.design_layout_tab_icon, iconViewParent, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            this.textView = (TextView) LayoutInflater.from(getContext()).inflate(C0633R.layout.design_layout_tab_text, textViewParent, false);
