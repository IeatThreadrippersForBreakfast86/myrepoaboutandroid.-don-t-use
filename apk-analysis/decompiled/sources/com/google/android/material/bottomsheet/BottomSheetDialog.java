...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C0633R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            this.container = (FrameLayout) View.inflate(getContext(), C0633R.layout.design_bottom_sheet_dialog, null);
            this.coordinator = (CoordinatorLayout) this.container.findViewById(C0633R.id.coordinator);
            this.bottomSheet = (FrameLayout) this.container.findViewById(C0633R.id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinator = (CoordinatorLayout) this.container.findViewById(C0633R.id.coordinator);
        ...
        coordinator.findViewById(C0633R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
    ...
    private static int getThemeResId(Context context, int themeId) {
        if (themeId == 0) {
            ...
            if (context.getTheme().resolveAttribute(C0633R.attr.bottomSheetDialogTheme, outValue, true)) {
                return outValue.resourceId;
            }
            return C0633R.style.Theme_Design_Light_BottomSheetDialog;
        }
        return themeId;
    }
