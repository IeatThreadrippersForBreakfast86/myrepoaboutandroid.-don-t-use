...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0633R.id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0633R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0633R.id.material_clock_face);
        this.toggle = (MaterialButtonToggleGroup) findViewById(C0633R.id.material_clock_period_toggle);
        this.toggle.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
                this.f$0.m143x9f44237d(materialButtonToggleGroup, i, z);
            }
        });
        this.minuteView = (Chip) findViewById(C0633R.id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0633R.id.material_hour_tv);
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0633R.id.selection_type, 12);
        this.hourView.setTag(C0633R.id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        int checkedId;
        if (period == 1) {
            checkedId = C0633R.id.material_clock_period_pm_button;
        } else {
            checkedId = C0633R.id.material_clock_period_am_button;
        }
