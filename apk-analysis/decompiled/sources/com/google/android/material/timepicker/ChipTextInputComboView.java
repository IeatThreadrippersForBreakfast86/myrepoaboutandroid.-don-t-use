...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.chip = (Chip) inflater.inflate(C0633R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip.setAccessibilityClassName("android.view.View");
        this.textInputLayout = (TextInputLayout) inflater.inflate(C0633R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C0633R.id.material_label);
