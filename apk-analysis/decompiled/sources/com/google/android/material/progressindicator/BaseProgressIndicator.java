...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_ProgressIndicator;
    ...
    protected BaseProgressIndicator(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0633R.styleable.BaseProgressIndicator, i, i2, new int[0]);
        this.showDelay = typedArrayObtainStyledAttributes.getInt(C0633R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(typedArrayObtainStyledAttributes.getInt(C0633R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public void setIndicatorColor(int... indicatorColors) {
        if (indicatorColors.length == 0) {
            indicatorColors = new int[]{MaterialColors.getColor(getContext(), C0633R.attr.colorPrimary, -1)};
        }
