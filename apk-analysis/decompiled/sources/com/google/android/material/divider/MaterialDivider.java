...
public class MaterialDivider extends View {
    ...
    public MaterialDivider(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.materialDividerStyle);
    }
    ...
    public MaterialDivider(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.MaterialDivider, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.thickness = attributes.getDimensionPixelSize(C0633R.styleable.MaterialDivider_dividerThickness, getResources().getDimensionPixelSize(C0633R.dimen.material_divider_thickness));
        ...
        setDividerColor(MaterialResources.getColorStateList(context2, attributes, C0633R.styleable.MaterialDivider_dividerColor).getDefaultColor());
        attributes.recycle();
    }
