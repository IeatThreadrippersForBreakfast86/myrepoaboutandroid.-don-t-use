...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.floatingActionButtonStyle);
    }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.FloatingActionButton, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.backgroundTint = MaterialResources.getColorStateList(context2, a, C0633R.styleable.FloatingActionButton_backgroundTint);
        this.backgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0633R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.rippleColor = MaterialResources.getColorStateList(context2, a, C0633R.styleable.FloatingActionButton_rippleColor);
        this.size = a.getInt(C0633R.styleable.FloatingActionButton_fabSize, -1);
        this.customSize = a.getDimensionPixelSize(C0633R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.borderWidth = a.getDimensionPixelSize(C0633R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C0633R.styleable.FloatingActionButton_elevation, 0.0f);
        float hoveredFocusedTranslationZ = a.getDimension(C0633R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float pressedTranslationZ = a.getDimension(C0633R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.compatPadding = a.getBoolean(C0633R.styleable.FloatingActionButton_useCompatPadding, false);
        int minTouchTargetSize = getResources().getDimensionPixelSize(C0633R.dimen.mtrl_fab_min_touch_target);
        setMaxImageSize(a.getDimensionPixelSize(C0633R.styleable.FloatingActionButton_maxImageSize, 0));
        MotionSpec showMotionSpec = MotionSpec.createFromAttribute(context2, a, C0633R.styleable.FloatingActionButton_showMotionSpec);
        MotionSpec hideMotionSpec = MotionSpec.createFromAttribute(context2, a, C0633R.styleable.FloatingActionButton_hideMotionSpec);
        ...
        boolean ensureMinTouchTargetSize = a.getBoolean(C0633R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
        setEnabled(a.getBoolean(C0633R.styleable.FloatingActionButton_android_enabled, true));
        a.recycle();
    ...
    private int getSizeDimension(int size) {
        ...
        switch (size) {
            ...
            case 0:
            default:
                return res.getDimensionPixelSize(C0633R.dimen.design_fab_size_normal);
            case 1:
                return res.getDimensionPixelSize(C0633R.dimen.design_fab_size_mini);
        }
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0633R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = a.getBoolean(C0633R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            a.recycle();
        }
