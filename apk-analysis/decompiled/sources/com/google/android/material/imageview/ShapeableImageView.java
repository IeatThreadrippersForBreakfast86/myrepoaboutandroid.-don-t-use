...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    private static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_ShapeableImageView;
    ...
    public ShapeableImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributes = context2.obtainStyledAttributes(attrs, C0633R.styleable.ShapeableImageView, defStyle, DEF_STYLE_RES);
        setLayerType(2, null);
        this.strokeColor = MaterialResources.getColorStateList(context2, attributes, C0633R.styleable.ShapeableImageView_strokeColor);
        this.strokeWidth = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_strokeWidth, 0);
        int contentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPadding, 0);
        ...
        this.leftContentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPaddingLeft, contentPadding);
        this.topContentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPaddingTop, contentPadding);
        this.rightContentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPaddingRight, contentPadding);
        this.bottomContentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPaddingBottom, contentPadding);
        this.startContentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPaddingStart, Integer.MIN_VALUE);
        this.endContentPadding = attributes.getDimensionPixelSize(C0633R.styleable.ShapeableImageView_contentPaddingEnd, Integer.MIN_VALUE);
        attributes.recycle();
