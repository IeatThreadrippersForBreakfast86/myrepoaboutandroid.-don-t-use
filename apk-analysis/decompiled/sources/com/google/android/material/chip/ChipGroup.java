...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_ChipGroup;
    ...
    public ChipGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.chipGroupStyle);
    }
    ...
    public ChipGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.ChipGroup, defStyleAttr, DEF_STYLE_RES, new int[0]);
        int chipSpacing = a.getDimensionPixelOffset(C0633R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(a.getDimensionPixelOffset(C0633R.styleable.ChipGroup_chipSpacingHorizontal, chipSpacing));
        setChipSpacingVertical(a.getDimensionPixelOffset(C0633R.styleable.ChipGroup_chipSpacingVertical, chipSpacing));
        setSingleLine(a.getBoolean(C0633R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(a.getBoolean(C0633R.styleable.ChipGroup_singleSelection, false));
        setSelectionRequired(a.getBoolean(C0633R.styleable.ChipGroup_selectionRequired, false));
        this.defaultCheckedId = a.getResourceId(C0633R.styleable.ChipGroup_checkedChip, -1);
        a.recycle();
