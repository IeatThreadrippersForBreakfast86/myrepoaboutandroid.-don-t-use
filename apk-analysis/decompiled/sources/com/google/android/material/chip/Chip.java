...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C0633R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0633R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0633R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        boolean hasShapeAppearanceAttribute = a.hasValue(C0633R.styleable.Chip_shapeAppearance);
        a.recycle();
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                this.f$0.m245lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z);
            }
        });
    }

    /* renamed from: lambda$new$0$com-google-android-material-chip-Chip, reason: not valid java name */
    /* synthetic */ void m245lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton buttonView, boolean isChecked) {
    ...
    private void initMinTouchTarget(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0633R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = a.getBoolean(C0633R.styleable.Chip_ensureMinTouchTargetSize, false);
        float defaultMinTouchTargetSize = (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48));
        this.minTouchTargetSize = (int) Math.ceil(a.getDimension(C0633R.styleable.Chip_chipMinTouchTargetSize, defaultMinTouchTargetSize));
        a.recycle();
    }
        ...
        protected void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            if (virtualViewId == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    node.setContentDescription(Chip.this.getContext().getString(C0633R.string.mtrl_chip_close_icon_content_description, TextUtils.isEmpty(chipText) ? "" : chipText).trim());
                }
