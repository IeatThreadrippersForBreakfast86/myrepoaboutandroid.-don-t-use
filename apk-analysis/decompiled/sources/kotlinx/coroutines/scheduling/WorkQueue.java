...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!C0143xc40028dd.m5m(lastScheduledTask$volatile$FU, this, lastScheduled, null));
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (value != null) {
            if ((value.taskContext.getTaskMode() == 1) == onlyBlocking && ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m176m(this.buffer, arrayIndex, value, null)) {
                if (onlyBlocking) {
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        } while (!C0143xc40028dd.m5m(lastScheduledTask$volatile$FU, this, r0, null));
