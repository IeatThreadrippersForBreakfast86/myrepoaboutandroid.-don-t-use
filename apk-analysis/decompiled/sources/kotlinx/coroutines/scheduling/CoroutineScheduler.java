...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    /* compiled from: CoroutineScheduler.kt */
    @Metadata(m145d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, m146d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;", "", "(Ljava/lang/String;I)V", "CPU_ACQUIRED", "BLOCKING", "PARKING", "DORMANT", "TERMINATED", "kotlinx-coroutines-core"}, m147k = 1, m148mv = {1, 9, 0}, m150xi = 48)
    ...
    */
    ...
    private final boolean tryCreateWorker(long state) throws Throwable {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final int createNewWorker() throws Throwable {
        boolean z;
        Object lock$iv = this.workers;
        synchronized (lock$iv) {
            try {
                ...
                if (newIndex > 0) {
                    try {
                        z = this.workers.get(newIndex) == null;
                    } catch (Throwable th) {
                        th = th;
                        throw th;
                    }
