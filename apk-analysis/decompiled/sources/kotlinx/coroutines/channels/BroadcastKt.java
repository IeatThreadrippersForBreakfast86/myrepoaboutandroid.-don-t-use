...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(final ReceiveChannel<? extends E> receiveChannel, int capacity, CoroutineStart start) {
        ...
        }, new C11252(receiveChannel, null), 1, null);
    }

    /* JADX INFO: Add missing generic type declarations: [E] */
    /* compiled from: Broadcast.kt */
    @Metadata(m145d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m146d2 = {"<anonymous>", "", "E", "Lkotlinx/coroutines/channels/ProducerScope;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.channels.BroadcastKt$broadcast$2", m162f = "Broadcast.kt", m163i = {0, 1}, m164l = {52, 53}, m165m = "invokeSuspend", m166n = {"$this$broadcast", "$this$broadcast"}, m167s = {"L$0", "L$0"})
    /* renamed from: kotlinx.coroutines.channels.BroadcastKt$broadcast$2 */
    static final class C11252<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C11252(ReceiveChannel<? extends E> receiveChannel, Continuation<? super C11252> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C11252 c11252 = new C11252(this.$channel, continuation);
            c11252.L$0 = obj;
            return c11252;
        }
        ...
        public final Object invoke(ProducerScope<? super E> producerScope, Continuation<? super Unit> continuation) {
            return ((C11252) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c11252 = this;
                    $this$broadcast = (ProducerScope) c11252.L$0;
                    it = c11252.$channel.iterator();
                    c11252.L$0 = $this$broadcast;
                    c11252.L$1 = it;
                    c11252.label = 1;
                    objHasNext = it.hasNext(c11252);
                    ...
                    if (!((Boolean) $result).booleanValue()) {
                        c112522.L$0 = $this$broadcast2;
                        c112522.L$1 = it;
                        c112522.label = 2;
                        Object e = $this$broadcast2.send(it.next(), c112522);
                        if (e == obj) {
                            return obj;
                        }
                        $result = $result2;
                ...
                case 2:
                    c11252 = this;
                    ChannelIterator<E> channelIterator2 = (ChannelIterator) c11252.L$1;
                    ProducerScope $this$broadcast4 = (ProducerScope) c11252.L$0;
                    ResultKt.throwOnFailure($result);
                    it = channelIterator2;
