...
public interface ReceiveChannel<E> {
    ...
    Object mo1761receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1762tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1762tryReceivePtdJZtk = receiveChannel.mo1762tryReceivePtdJZtk();
            if (ChannelResult.m1778isSuccessimpl(objMo1762tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1774getOrThrowimpl(objMo1762tryReceivePtdJZtk);
            }
            Throwable thM1772exceptionOrNullimpl = ChannelResult.m1772exceptionOrNullimpl(objMo1762tryReceivePtdJZtk);
            if (thM1772exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1772exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            C11761 c117612 = c11761;
            Object $result = c117612.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            switch (c117612.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    c117612.label = 1;
                    objMo1761receiveCatchingJP2dKIU = receiveChannel.mo1761receiveCatchingJP2dKIU(c117612);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1761receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1773getOrNullimpl(objMo1761receiveCatchingJP2dKIU);
        }
