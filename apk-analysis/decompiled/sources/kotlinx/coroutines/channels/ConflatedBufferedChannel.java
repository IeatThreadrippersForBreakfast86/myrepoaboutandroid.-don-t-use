...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m1785trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m1772exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m1785trySendImplMj0NB7M(e, true);
    ...
    public Object mo1757trySendJP2dKIU(E element) {
        return m1785trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1785trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1784trySendDropLatestMj0NB7M(element, isSendOp) : m1763trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1784trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo1757trySendJP2dKIU(element);
        if (ChannelResult.m1778isSuccessimpl(result) || ChannelResult.m1776isClosedimpl(result)) {
            return result;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object it = mo1757trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m1772exceptionOrNullimpl(it);
