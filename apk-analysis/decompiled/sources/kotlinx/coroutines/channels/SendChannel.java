...
public interface SendChannel<E> {
    ...
    Object mo1757trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1757trySendJP2dKIU(e);
            if (ChannelResult.m1778isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1772exceptionOrNullimpl = ChannelResult.m1772exceptionOrNullimpl(result);
