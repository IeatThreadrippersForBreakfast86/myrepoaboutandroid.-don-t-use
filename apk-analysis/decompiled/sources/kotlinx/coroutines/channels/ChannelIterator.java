...
@Metadata(m145d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\bf\u0018\u0000*\u0006\b\u0000\u0010\u0001 \u00012\u00020\u0002J\u000e\u0010\u0003\u001a\u00020\u0004H¦B¢\u0006\u0002\u0010\u0005J\u000e\u0010\u0006\u001a\u00028\u0000H¦\u0002¢\u0006\u0002\u0010\u0007J\u0010\u0010\b\u001a\u00028\u0000H\u0097@¢\u0006\u0004\b\u0006\u0010\u0005¨\u0006\t"}, m146d2 = {"Lkotlinx/coroutines/channels/ChannelIterator;", "E", "", "hasNext", "", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "next", "()Ljava/lang/Object;", "next0", "kotlinx-coroutines-core"}, m147k = 1, m148mv = {1, 9, 0}, m150xi = 48)
        ...
        public static /* synthetic */ Object next(ChannelIterator $this, Continuation continuation) {
            ...
            switch (channelIterator$next0$12.label) {
                case 0:
                    ...
                    channelIterator$next0$12.L$0 = $this;
                    channelIterator$next0$12.label = 1;
                    objHasNext = $this.hasNext(channelIterator$next0$12);
                    if (objHasNext == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
                    $this = (ChannelIterator) channelIterator$next0$12.L$0;
                    ResultKt.throwOnFailure($result);
                    objHasNext = $result;
                    break;
                default:
