...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C12702<T> implements FlowCollector {
        final /* synthetic */ FlowCollector $this_unsafeFlow;
        final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
        @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", m162f = "Transform.kt", m163i = {}, m164l = {219, 219}, m165m = "emit", m166n = {}, m167s = {})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C12702.this.emit(null, this);
            }
        }

        public C12702(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C12702(collector, this.$transform$inlined$1), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        C12702 c12702 = new C12702(collector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c12702, $completion);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
