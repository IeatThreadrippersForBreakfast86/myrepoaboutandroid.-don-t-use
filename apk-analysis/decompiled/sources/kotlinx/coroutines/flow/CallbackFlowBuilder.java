...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m162f = "Builders.kt", m163i = {0}, m164l = {330}, m165m = "collectTo", m166n = {"scope"}, m167s = {"L$0"})
    ...
    static final class C11881 extends ContinuationImpl {
        ...
        C11881(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C11881> continuation) {
            super(continuation);
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C11881) {
            ...
            if ((c11881.label & Integer.MIN_VALUE) != 0) {
                ...
                c11881 = new C11881(this, continuation);
            }
        }
        C11881 c118812 = c11881;
        Object $result = c118812.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c118812.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                c118812.L$0 = producerScope;
                c118812.label = 1;
                if (super.collectTo(producerScope, c118812) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
                producerScope = (ProducerScope) c118812.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
