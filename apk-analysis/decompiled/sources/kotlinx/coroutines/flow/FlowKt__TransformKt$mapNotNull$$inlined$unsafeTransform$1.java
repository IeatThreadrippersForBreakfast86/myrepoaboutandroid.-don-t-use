...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C12722<T> implements FlowCollector {
        final /* synthetic */ FlowCollector $this_unsafeFlow;
        final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
        @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m162f = "Transform.kt", m163i = {0}, m164l = {219, 220}, m165m = "emit", m166n = {"$this$mapNotNull_u24lambda_u246"}, m167s = {"L$0"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C12722.this.emit(null, this);
            }
        }

        public C12722(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C12722(collector, this.$transform$inlined$1), $completion);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        C12722 c12722 = new C12722(collector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c12722, $completion);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
