...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> m1797catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    public static /* synthetic */ Flow retry$default(Flow flow, long j, Function2 function2, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            function2 = new C12251(null);
        }
        return FlowKt.retry(flow, j, function2);
    }

    /* compiled from: Errors.kt */
    @Metadata(m145d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "it", ""}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1", m162f = "Errors.kt", m163i = {}, m164l = {}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1 */
    static final class C12251 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C12251(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C12251) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* compiled from: Errors.kt */
    @Metadata(m145d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", ""}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", m162f = "Errors.kt", m163i = {}, m164l = {WKSRecord.Service.MIT_DOV}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3 */
    static final class C12263<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        ...
        C12263(long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super C12263> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C12263 c12263 = new C12263(this.$retries, this.$predicate, continuation);
            c12263.L$0 = th;
            c12263.J$0 = j;
            return c12263.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long retries, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        return FlowKt.retryWhen(flow, new C12263(retries, function2, null));
    }
    ...
    */
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) throws Throwable {
        ...
        C12231 c122312 = c12231;
        Object obj = c122312.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c122312.label) {
            case 0:
                ResultKt.throwOnFailure(obj);
                Ref.ObjectRef objectRef2 = new Ref.ObjectRef();
                try {
                    FlowCollector<? super Object> c12242 = new C12242<>(flowCollector, objectRef2);
                    c122312.L$0 = objectRef2;
                    c122312.label = 1;
                    if (flow.collect(c12242, c122312) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return null;
                } catch (Throwable th) {
            ...
            case 1:
                objectRef = (Ref.ObjectRef) c122312.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
                    return null;
                } catch (Throwable th2) {
        ...
        if (isSameExceptionAs$FlowKt__ErrorsKt(th, th3) || isCancellationCause$FlowKt__ErrorsKt(th, c122312.get$context())) {
            throw th;
        }
        if (th3 == null) {
            return th;
    ...
    static final class C12242<T> implements FlowCollector {
        final /* synthetic */ FlowCollector<T> $collector;
        final /* synthetic */ Ref.ObjectRef<Throwable> $fromDownstream;

        /* JADX WARN: Multi-variable type inference failed */
        C12242(FlowCollector<? super T> flowCollector, Ref.ObjectRef<Throwable> objectRef) {
            ...
            switch (flowKt__ErrorsKt$catchImpl$2$emit$12.label) {
                case 0:
                    ...
                    try {
                        ...
                        if (flowCollector.emit(t, flowKt__ErrorsKt$catchImpl$2$emit$12) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    ...
                    L2d:
                        ...
                        kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2 r6 = (kotlinx.coroutines.flow.FlowKt__ErrorsKt.C12242) r6
                    ...
                    L51:
                        ...
                        throw r1
                    */
                    throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt.C12242.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }
