...
final /* synthetic */ class FlowKt__EmittersKt {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1", m162f = "Emitters.kt", m163i = {}, m164l = {36}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1 */
    public static final class C12201<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C12201(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C12201> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C12201 c12201 = new C12201(this.$this_transform, this.$transform, continuation);
            c12201.L$0 = obj;
            return c12201;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C12201) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> transform(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.flow(new C12201(flow, function3, null));
    }
        ...
        switch (flowKt__EmittersKt$invokeSafely$12.label) {
            case 0:
                ...
                try {
                    ...
                    if (function3.invoke(flowCollector, cause, flowKt__EmittersKt$invokeSafely$12) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return Unit.INSTANCE;
                } catch (Throwable th) {
