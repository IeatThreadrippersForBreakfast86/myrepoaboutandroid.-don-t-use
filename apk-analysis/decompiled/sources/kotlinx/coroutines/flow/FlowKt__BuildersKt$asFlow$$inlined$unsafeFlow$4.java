...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m162f = "Builders.kt", m163i = {0}, m164l = {114}, m165m = "collect", m166n = {"$this$asFlow_u24lambda_u245"}, m167s = {"L$0"})
    ...
    public static final class C11941 extends ContinuationImpl {
        ...
        public C11941(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        C11941 c119412 = c11941;
        Object obj = c119412.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c119412.label) {
            case 0:
                ...
                break;
            case 1:
                it = (Iterator) c119412.L$1;
                FlowCollector flowCollector3 = (FlowCollector) c119412.L$0;
                ResultKt.throwOnFailure(obj);
        ...
        while (it.hasNext()) {
            Object next = it.next();
            c119412.L$0 = flowCollector2;
            c119412.L$1 = it;
            c119412.label = 1;
            if (flowCollector2.emit(next, c119412) == coroutine_suspended) {
