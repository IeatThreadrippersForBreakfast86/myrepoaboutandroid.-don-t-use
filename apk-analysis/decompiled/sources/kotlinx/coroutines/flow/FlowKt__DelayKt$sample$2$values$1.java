...
@DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m162f = "Delay.kt", m163i = {}, m164l = {273}, m165m = "invokeSuspend", m166n = {}, m167s = {})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C12151<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C12151(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.$this_sample.collect(new C12151($this$produce), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
