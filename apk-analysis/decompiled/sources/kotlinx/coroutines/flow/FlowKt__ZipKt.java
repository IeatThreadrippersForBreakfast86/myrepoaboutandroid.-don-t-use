...
final /* synthetic */ class FlowKt__ZipKt {
    ...
    public static final <T1, T2, R> Flow<R> flowCombineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> function4) {
        ...
        return FlowKt.flow(new C1280xd7c321e6(flows$iv, null, function4));
    }
    ...
    public static final <T1, T2, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> function4) {
        Flow[] flows$iv = {flow, flow2};
        return FlowKt.flow(new C1281xd7c321e7(flows$iv, null, function4));
    }
    ...
    public static final <T1, T2, T3, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, final Function4<? super T1, ? super T2, ? super T3, ? super Continuation<? super R>, ? extends Object> function4) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1
            ...
            public Object collect(FlowCollector collector, Continuation $completion) {
                Object objCombineInternal = CombineKt.combineInternal(collector, flows$iv, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new C12752(null, function4), $completion);
                return objCombineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCombineInternal : Unit.INSTANCE;
            }

            /* compiled from: Zip.kt */
            @Metadata(m145d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@¨\u0006\u0007"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
            @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1$2", m162f = "Zip.kt", m163i = {}, m164l = {329, Type.AVC}, m165m = "invokeSuspend", m166n = {}, m167s = {})
            /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1$2 */
            public static final class C12752 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                public C12752(Continuation continuation, Function4 function4) {
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C12752 c12752 = new C12752(continuation, this.$transform$inlined);
                    c12752.L$0 = flowCollector;
                    c12752.L$1 = objArr;
                    return c12752.invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c12752.L$0 = null;
                            c12752.label = 2;
                            return flowCollector.emit($result, c12752) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            c12752 = this;
                            ...
                            c12752.L$0 = null;
                            c12752.label = 2;
                            if (flowCollector.emit($result, c12752) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
    ...
    public static final <T1, T2, T3, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Function5<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super Continuation<? super Unit>, ? extends Object> function5) {
        ...
        return FlowKt.flow(new C1282xd7c321e8(flows$iv, null, function5));
    }
    ...
    public static final <T1, T2, T3, T4, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, final Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super R>, ? extends Object> function5) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2
            @Override // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector collector, Continuation $completion) {
                Object objCombineInternal = CombineKt.combineInternal(collector, flows$iv, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new C12762(null, function5), $completion);
                return objCombineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCombineInternal : Unit.INSTANCE;
            }

            /* compiled from: Zip.kt */
            @Metadata(m145d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@¨\u0006\u0007"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
            @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2$2", m162f = "Zip.kt", m163i = {}, m164l = {329, Type.AVC}, m165m = "invokeSuspend", m166n = {}, m167s = {})
            /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2$2 */
            public static final class C12762 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C12762(Continuation continuation, Function5 function5) {
                    super(3, continuation);
                ...
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C12762 c12762 = new C12762(continuation, this.$transform$inlined);
                    c12762.L$0 = flowCollector;
                    c12762.L$1 = objArr;
                    return c12762.invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c12762.L$0 = null;
                            c12762.label = 2;
                            return flowCollector.emit($result, c12762) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            c12762 = this;
                            ...
                            c12762.L$0 = null;
                            c12762.label = 2;
                            if (flowCollector.emit($result, c12762) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
    ...
    public static final <T1, T2, T3, T4, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Function6<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super Unit>, ? extends Object> function6) {
        ...
        return FlowKt.flow(new C1283xd7c321e9(flows$iv, null, function6));
    }
    ...
    public static final <T1, T2, T3, T4, T5, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Flow<? extends T5> flow5, final Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super R>, ? extends Object> function6) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3
            @Override // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector collector, Continuation $completion) {
                Object objCombineInternal = CombineKt.combineInternal(collector, flows$iv, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new C12772(null, function6), $completion);
                return objCombineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCombineInternal : Unit.INSTANCE;
            }

            /* compiled from: Zip.kt */
            @Metadata(m145d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@¨\u0006\u0007"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "kotlinx/coroutines/flow/FlowKt__ZipKt$combineUnsafe$1$1"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
            @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3$2", m162f = "Zip.kt", m163i = {}, m164l = {329, Type.AVC}, m165m = "invokeSuspend", m166n = {}, m167s = {})
            /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3$2 */
            public static final class C12772 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C12772(Continuation continuation, Function6 function6) {
                    super(3, continuation);
                ...
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
                    C12772 c12772 = new C12772(continuation, this.$transform$inlined);
                    c12772.L$0 = flowCollector;
                    c12772.L$1 = objArr;
                    return c12772.invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c12772.L$0 = null;
                            c12772.label = 2;
                            return flowCollector.emit($result, c12772) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            flowCollector = (FlowCollector) this.L$0;
                            ResultKt.throwOnFailure($result);
                            c12772 = this;
                            ...
                            c12772.L$0 = null;
                            c12772.label = 2;
                            if (flowCollector.emit($result, c12772) != coroutine_suspended) {
                            }
                            break;
                        case 2:
                            ResultKt.throwOnFailure($result);
    ...
    public static final <T1, T2, T3, T4, T5, R> Flow<R> combineTransform(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Flow<? extends T5> flow5, Function7<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super Unit>, ? extends Object> function7) {
        ...
        return FlowKt.flow(new C1284xd7c321ea(flows$iv, null, function7));
    }
    ...
    /* compiled from: Zip.kt */
    @Metadata(m145d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", m162f = "Zip.kt", m163i = {}, m164l = {247}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6 */
    public static final class C12866<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C12866(Flow<? extends T>[] flowArr, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C12866> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C12866 c12866 = new C12866(this.$flows, this.$transform, continuation);
            c12866.L$0 = obj;
            return c12866;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C12866) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX INFO: Add missing generic type declarations: [T] */
        /* compiled from: Zip.kt */
        @Metadata(m145d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0004\u0010\u0000\u001a\f\u0012\u0006\u0012\u0004\u0018\u0001H\u0002\u0018\u00010\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m146d2 = {"<anonymous>", "", "T", "R", "invoke", "()[Ljava/lang/Object;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
        ...
        /* JADX INFO: Add missing generic type declarations: [T] */
        /* compiled from: Zip.kt */
        @Metadata(m145d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
        @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", m162f = "Zip.kt", m163i = {}, m164l = {247}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    ...
    public static final /* synthetic */ <T, R> Flow<R> combineTransform(Flow<? extends T>[] flowArr, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3) {
        Intrinsics.needClassReification();
        return FlowKt.flow(new C12866(flowArr, function3, null));
    }
    ...
    /* compiled from: Zip.kt */
    @Metadata(m145d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", m162f = "Zip.kt", m163i = {}, m164l = {304}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7 */
    public static final class C12877<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C12877(Flow<T>[] flowArr, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super C12877> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C12877 c12877 = new C12877(this.$flowArray, this.$transform, continuation);
            c12877.L$0 = obj;
            return c12877;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C12877) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        /* compiled from: Zip.kt */
        @Metadata(m145d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 176)
        @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m162f = "Zip.kt", m163i = {}, m164l = {304}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    ...
    public static final /* synthetic */ <T, R> Flow<R> combineTransform(Iterable<? extends Flow<? extends T>> iterable, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        Flow[] flowArray = (Flow[]) $this$toTypedArray$iv.toArray(new Flow[0]);
        Intrinsics.needClassReification();
        return FlowKt.flow(new C12877(flowArray, function3, null));
    }
