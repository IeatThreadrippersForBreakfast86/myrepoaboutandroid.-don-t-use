...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    /* compiled from: Migration.kt */
    @Metadata(m145d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "e", ""}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$onErrorReturn$2", m162f = "Migration.kt", m163i = {}, m164l = {302}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__MigrationKt$onErrorReturn$2 */
    static final class C12402<T> extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
        ...
        C12402(Function1<? super Throwable, Boolean> function1, T t, Continuation<? super C12402> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
            C12402 c12402 = new C12402(this.$predicate, this.$fallback, continuation);
            c12402.L$0 = flowCollector;
            c12402.L$1 = th;
            return c12402.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m1786catch(flow, new C12402(function1, t, null));
    }
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Migration.kt */
    @Metadata(m145d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayFlow$1", m162f = "Migration.kt", m163i = {}, m164l = {411}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__MigrationKt$delayFlow$1 */
    static final class C12381<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C12381(long j, Continuation<? super C12381> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C12381(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C12381) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long timeMillis) {
        return FlowKt.onStart(flow, new C12381(timeMillis, null));
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Migration.kt */
    @Metadata(m145d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "it"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1", m162f = "Migration.kt", m163i = {}, m164l = {TypedValues.CycleType.TYPE_WAVE_PERIOD}, m165m = "invokeSuspend", m166n = {}, m167s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1 */
    static final class C12371<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C12371(long j, Continuation<? super C12371> continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C12371(this.$timeMillis, continuation);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return invoke2((C12371<T>) obj, continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Unit> continuation) {
            return ((C12371) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayEach(Flow<? extends T> flow, long timeMillis) {
        return FlowKt.onEach(flow, new C12371(timeMillis, null));
    }
