...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        Object objCollect = this.flow.collect(new C12982(job, semaphore, producerScope, collector), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    /* compiled from: Merge.kt */
    @Metadata(m145d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m146d2 = {"<anonymous>", "", "T", "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2 */
    static final class C12982<T> implements FlowCollector {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C12982(Job job, Semaphore semaphore, ProducerScope<? super T> producerScope, SendingCollector<T> sendingCollector) {
            this.$job = job;
        ...
        public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) {
            ...
            switch (channelFlowMerge$collectTo$2$emit$12.label) {
                ...
                case 1:
                    ...
                    c12982 = (C12982) channelFlowMerge$collectTo$2$emit$12.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            BuildersKt__Builders_commonKt.launch$default(c12982.$scope, null, null, new AnonymousClass1(flow, c12982.$collector, c12982.$semaphore, null), 3, null);
            return Unit.INSTANCE;
        }

        /* compiled from: Merge.kt */
        @Metadata(m145d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m146d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
        @DebugMetadata(m161c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m162f = "Merge.kt", m163i = {}, m164l = {65}, m165m = "invokeSuspend", m166n = {}, m167s = {})
