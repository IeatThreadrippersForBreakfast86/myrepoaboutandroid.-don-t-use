...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m162f = "Reduce.kt", m163i = {0, 0}, m164l = {WKSRecord.Service.NETBIOS_SSN}, m165m = "emit", m166n = {"this", "it"}, m167s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1 */
    public static final class C12411 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C12411(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        Object obj = c124112.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        boolean z = true;
        switch (c124112.label) {
            case 0:
                ...
                c124112.L$0 = flowKt__ReduceKt$first$$inlined$collectWhile$2;
                c124112.L$1 = t;
                c124112.label = 1;
                InlineMarker.mark(6);
                objInvoke = function2.invoke(t, c124112);
                InlineMarker.mark(7);
            ...
            case 1:
                t2 = (T) c124112.L$1;
                flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c124112.L$0;
                ResultKt.throwOnFailure(obj);
                objInvoke = obj;
                break;
            default:
