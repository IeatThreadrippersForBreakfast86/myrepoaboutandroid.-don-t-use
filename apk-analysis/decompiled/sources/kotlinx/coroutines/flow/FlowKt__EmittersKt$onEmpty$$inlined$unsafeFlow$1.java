...
public final class FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1", m162f = "Emitters.kt", m163i = {0, 0, 0, 1}, m164l = {WKSRecord.Service.AUTH, WKSRecord.Service.ERPC}, m165m = "collect", m166n = {"this", "$this$onEmpty_u24lambda_u243", "isEmpty", "collector"}, m167s = {"L$0", "L$1", "L$2", "L$0"})
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        FlowCollector $this$onEmpty_u24lambda_u243;
        ...
        C12171 c121712 = c12171;
        Object $result = c121712.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c121712.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 = this;
                $this$onEmpty_u24lambda_u243 = flowCollector;
                ...
                FlowKt__EmittersKt$onEmpty$1$1 flowKt__EmittersKt$onEmpty$1$1 = new FlowKt__EmittersKt$onEmpty$1$1(isEmpty, $this$onEmpty_u24lambda_u243);
                c121712.L$0 = flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1;
                c121712.L$1 = $this$onEmpty_u24lambda_u243;
                c121712.L$2 = isEmpty;
                c121712.label = 1;
                if (flow.collect(flowKt__EmittersKt$onEmpty$1$1, c121712) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                if (isEmpty.element) {
                    SafeCollector collector2 = new SafeCollector($this$onEmpty_u24lambda_u243, c121712.getContext());
                    try {
                        Function2 function2 = flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.$action$inlined;
                        c121712.L$0 = collector2;
                        c121712.L$1 = null;
                        c121712.L$2 = null;
                        c121712.label = 2;
                        InlineMarker.mark(6);
                        Object objInvoke = function2.invoke(collector2, c121712);
                        InlineMarker.mark(7);
            ...
            case 1:
                isEmpty = (Ref.BooleanRef) c121712.L$2;
                $this$onEmpty_u24lambda_u243 = (FlowCollector) c121712.L$1;
                flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 = (FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1) c121712.L$0;
                ResultKt.throwOnFailure($result);
                if (isEmpty.element) {
                }
                return Unit.INSTANCE;
            case 2:
                collector = (SafeCollector) c121712.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    collector.releaseIntercepted();
                    return Unit.INSTANCE;
