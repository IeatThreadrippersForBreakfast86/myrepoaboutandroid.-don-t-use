...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m162f = "Builders.kt", m163i = {0}, m164l = {114}, m165m = "collect", m166n = {"$this$asFlow_u24lambda_u247"}, m167s = {"L$0"})
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        C11951 c119512 = c11951;
        Object $result = c119512.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c119512.label) {
            case 0:
                ...
                break;
            case 1:
                it = (Iterator) c119512.L$1;
                $this$asFlow_u24lambda_u247 = (FlowCollector) c119512.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
        ...
        while (it.hasNext()) {
            T next = it.next();
            c119512.L$0 = $this$asFlow_u24lambda_u247;
            c119512.L$1 = it;
            c119512.label = 1;
            Object value = $this$asFlow_u24lambda_u247.emit(next, c119512);
