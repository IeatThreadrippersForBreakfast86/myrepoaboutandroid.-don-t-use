...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM255constructorimpl = Result.m255constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM255constructorimpl = Result.m255constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m261isFailureimpl(objM255constructorimpl) ? null : objM255constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1813dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
