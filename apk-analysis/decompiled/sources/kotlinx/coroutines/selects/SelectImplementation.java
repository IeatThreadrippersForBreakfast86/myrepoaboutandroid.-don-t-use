...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    @DebugMetadata(m161c = "kotlinx.coroutines.selects.SelectImplementation", m162f = "Select.kt", m163i = {0}, m164l = {438, 441}, m165m = "doSelectSuspend", m166n = {"this"}, m167s = {"L$0"})
    ...
    static final class C13141 extends ContinuationImpl {
        ...
        C13141(SelectImplementation<R> selectImplementation, Continuation<? super C13141> continuation) {
            super(continuation);
    ...
    /* compiled from: Select.kt */
    @Metadata(m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlinx.coroutines.selects.SelectImplementation", m162f = "Select.kt", m163i = {}, m164l = {712}, m165m = "processResultAndInvokeBlockRecoveringException", m166n = {}, m167s = {})
    ...
    static final class C13151 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C13151(SelectImplementation<R> selectImplementation, Continuation<? super C13151> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object doSelectSuspend(Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C13141) {
            ...
            if ((c13141.label & Integer.MIN_VALUE) != 0) {
                ...
                c13141 = new C13141(this, continuation);
            }
        }
        C13141 c131412 = c13141;
        Object $result = c131412.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c131412.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                selectImplementation = this;
                c131412.L$0 = selectImplementation;
                c131412.label = 1;
                if (selectImplementation.waitUntilSelected(c131412) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
                selectImplementation = (SelectImplementation) c131412.L$0;
                ResultKt.throwOnFailure($result);
                break;
            case 2:
                ResultKt.throwOnFailure($result);
        ...
        c131412.L$0 = null;
        c131412.label = 2;
        Object objComplete = selectImplementation.complete(c131412);
    ...
    public final Object waitUntilSelected(Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (curState == SelectKt.STATE_REG) {
                if (C0143xc40028dd.m5m(state$volatile$FU, this, curState, cont)) {
                    CancellableContinuationKt.invokeOnCancellation(cont, this);
                    break;
                }
            } else if (curState instanceof List) {
                if (C0143xc40028dd.m5m(state$volatile$FU, this, curState, SelectKt.STATE_REG)) {
        ...
        while (true) {
            ...
            if (!(curState instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(curState, SelectKt.STATE_REG)) {
                    if (C0143xc40028dd.m5m(state$volatile$FU, this, curState, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (C0143xc40028dd.m5m(state$volatile$FU, this, curState, CollectionsKt.plus((Collection<? extends Object>) curState, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clause == null) {
                    ...
                    if (C0143xc40028dd.m5m(state$volatile$FU, this, curState, clause)) {
    ...
    */
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object internalResult, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C13151) {
            ...
            if ((c13151.label & Integer.MIN_VALUE) != 0) {
                ...
                c13151 = new C13151(this, continuation);
            }
        }
        C13151 c131512 = c13151;
        Object $result = c131512.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        try {
            switch (c131512.label) {
                case 0:
                    ResultKt.throwOnFailure($result);
                    Object blockArgument = clauseData.processResult(internalResult);
                    c131512.label = 1;
                    objInvokeBlock = clauseData.invokeBlock(blockArgument, c131512);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c131512 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(e, c131512);
            }
            throw e;
        }
    }
    ...
    public void invoke(Throwable cause) {
        ...
        } while (!C0143xc40028dd.m5m(handler$atomicfu$iv, this, cur, SelectKt.STATE_CANCELLED));
        Iterable clauses = this.clauses;
        if (clauses == null) {
            return;
        }
