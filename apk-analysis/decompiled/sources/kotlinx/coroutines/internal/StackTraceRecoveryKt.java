...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM255constructorimpl = Result.m255constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m258exceptionOrNullimpl(objM255constructorimpl) == null) {
            obj2 = objM255constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM255constructorimpl2 = Result.m255constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM255constructorimpl2 = Result.m255constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m258exceptionOrNullimpl(objM255constructorimpl2) == null) {
            obj = objM255constructorimpl2;
        }
