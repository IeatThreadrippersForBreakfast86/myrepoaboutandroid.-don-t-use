...
public class LockFreeTaskQueue<E> {
    ...
    public final void close() {
        ...
        while (true) {
            ...
            if (cur.close()) {
                ...
                C0143xc40028dd.m5m(_cur$volatile$FU, this, cur, cur.next());
            }
        }
    }
    ...
    public final E removeFirstOrNull() {
        ...
        while (true) {
            ...
            C0143xc40028dd.m5m(_cur$volatile$FU, this, lockFreeTaskQueueCore, lockFreeTaskQueueCore.next());
        }
    }
