...
public abstract class ConcurrentLinkedListNode<N extends ConcurrentLinkedListNode<N>> {
    ...
    public final boolean trySetNext(N value) {
        return C0143xc40028dd.m5m(_next$volatile$FU, this, null, value);
    }
    ...
    public final boolean markAsClosed() {
        return C0143xc40028dd.m5m(_next$volatile$FU, this, null, ConcurrentLinkedListKt.CLOSED);
    }
    ...
    public final void remove() {
        ...
        while (true) {
            ...
            } while (!C0143xc40028dd.m5m(handler$atomicfu$iv, next, obj, it == null ? null : prev));
            if (prev != null) {
