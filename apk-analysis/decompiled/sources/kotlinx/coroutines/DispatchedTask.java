...
public abstract class DispatchedTask<T> extends Task {
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x00c8 A[Catch: all -> 0x0105, TryCatch #1 {all -> 0x0105, blocks: (B:42:0x00b0, B:43:0x00b3, B:48:0x00e3, B:38:0x00a0, B:46:0x00c8, B:47:0x00d6), top: B:78:0x0071 }] */
    /* JADX WARN: Removed duplicated region for block: B:47:0x00d6 A[Catch: all -> 0x0105, TryCatch #1 {all -> 0x0105, blocks: (B:42:0x00b0, B:43:0x00b3, B:48:0x00e3, B:38:0x00a0, B:46:0x00c8, B:47:0x00d6), top: B:78:0x0071 }] */
    /* JADX WARN: Removed duplicated region for block: B:52:0x00ef A[Catch: all -> 0x0119, TRY_LEAVE, TryCatch #4 {all -> 0x0119, blocks: (B:13:0x001e, B:15:0x0040, B:50:0x00e9, B:52:0x00ef, B:63:0x010e, B:67:0x0118, B:65:0x0114), top: B:84:0x001e }] */
    /* JADX WARN: Removed duplicated region for block: B:65:0x0114 A[Catch: all -> 0x0119, TryCatch #4 {all -> 0x0119, blocks: (B:13:0x001e, B:15:0x0040, B:50:0x00e9, B:52:0x00ef, B:63:0x010e, B:67:0x0118, B:65:0x0114), top: B:84:0x001e }] */
                    ...
                    try {
                        ...
                        try {
                            if (job == null && !job.isActive()) {
                                ...
                                if (DebugKt.getRECOVER_STACK_TRACES()) {
                                    try {
                                        if (continuation instanceof CoroutineStackFrame) {
                                            ...
                                            continuation.resumeWith(Result.m255constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                                        }
                                    } catch (Throwable th) {
                                        th = th;
                                ...
                                continuation.resumeWith(Result.m255constructorimpl(ResultKt.createFailure(exception)));
                            } else {
                                Result.Companion companion3 = Result.INSTANCE;
                                continuation.resumeWith(Result.m255constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                            }
                            ...
                            try {
                                ...
                                result = Result.m255constructorimpl(Unit.INSTANCE);
                            } catch (Throwable th2) {
                                th = th2;
                                Result.Companion companion5 = Result.INSTANCE;
                                result = Result.m255constructorimpl(ResultKt.createFailure(th));
                                handleFatalException$kotlinx_coroutines_core(fatalException, Result.m258exceptionOrNullimpl(result));
                            }
                        } catch (Throwable th3) {
                            th = th3;
                        }
