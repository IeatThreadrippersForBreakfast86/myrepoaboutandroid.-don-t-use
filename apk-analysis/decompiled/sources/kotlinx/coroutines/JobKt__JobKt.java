...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final DisposableHandle invokeOnCompletion(Job $this$invokeOnCompletion, boolean onCancelling, boolean invokeImmediately, InternalCompletionHandler handler) {
        return $this$invokeOnCompletion instanceof JobSupport ? ((JobSupport) $this$invokeOnCompletion).invokeOnCompletionInternal$kotlinx_coroutines_core(onCancelling, invokeImmediately, handler) : $this$invokeOnCompletion.invokeOnCompletion(onCancelling, invokeImmediately, new C11161(handler));
    }

    /* compiled from: Job.kt */
    @Metadata(m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    /* renamed from: kotlinx.coroutines.JobKt__JobKt$invokeOnCompletion$1 */
    /* synthetic */ class C11161 extends FunctionReferenceImpl implements Function1<Throwable, Unit> {
        C11161(Object obj) {
    ...
    public static final /* synthetic */ Job m1750Job(Job parent) {
        return JobKt.Job(parent);
    }

    /* renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1751Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1750Job(job);
