...
public final class CancellableKt {
    public static final <T> void startCoroutineCancellable(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) throws Throwable {
        try {
            ...
            DispatchedContinuationKt.resumeCancellableWith$default(continuationIntercepted, Result.m255constructorimpl(Unit.INSTANCE), null, 2, null);
    ...
    public static final <R, T> void startCoroutineCancellable(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation, Function1<? super Throwable, Unit> function1) throws Throwable {
        try {
            ...
            Result.Companion companion = Result.INSTANCE;
            DispatchedContinuationKt.resumeCancellableWith(continuationIntercepted, Result.m255constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable e$iv) {
            dispatcherFailure(continuation, e$iv);
        }
    }
    ...
    private static final void dispatcherFailure(Continuation<?> continuation, Throwable e) throws Throwable {
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m255constructorimpl(ResultKt.createFailure(e)));
        throw e;
    }
}
