...
public final class Regex implements Serializable {
    ...
    public final Sequence<MatchResult> findAll(final CharSequence input, final int startIndex) {
        ...
        }, (Function1) C10952.INSTANCE);
    }

    /* compiled from: Regex.kt */
    @Metadata(m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    /* renamed from: kotlin.text.Regex$findAll$2 */
    /* synthetic */ class C10952 extends FunctionReferenceImpl implements Function1<MatchResult, MatchResult> {
        public static final C10952 INSTANCE = new C10952();
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C10961(input, limit, null));
    }

    /* compiled from: Regex.kt */
    @Metadata(m145d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m146d2 = {"<anonymous>", "", "Lkotlin/sequences/SequenceScope;", ""}, m147k = 3, m148mv = {1, 9, 0}, m150xi = 48)
    @DebugMetadata(m161c = "kotlin.text.Regex$splitToSequence$1", m162f = "Regex.kt", m163i = {1, 1, 1}, m164l = {275, 283, 287}, m165m = "invokeSuspend", m166n = {"$this$sequence", "matcher", "splitCount"}, m167s = {"L$0", "L$1", "I$0"})
    /* renamed from: kotlin.text.Regex$splitToSequence$1 */
    static final class C10961 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C10961(CharSequence charSequence, int i, Continuation<? super C10961> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C10961 c10961 = Regex.this.new C10961(this.$input, this.$limit, continuation);
            c10961.L$0 = obj;
            return c10961;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C10961) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c10961 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c10961.L$0;
                    matcher = Regex.this.nativePattern.matcher(c10961.$input);
                    if (c10961.$limit == 1 || !matcher.find()) {
                        c10961.label = 1;
                        return $this$sequence2.yield(c10961.$input.toString(), c10961) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c10961.L$0 = $this$sequence;
                    c10961.L$1 = matcher;
                    c10961.I$0 = splitCount;
                    c10961.label = 2;
                    if ($this$sequence.yield(c10961.$input.subSequence(nextStart, matcher.start()).toString(), c10961) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c10961.$limit - 1 || !matcher.find()) {
                        c10961.L$0 = null;
                        c10961.L$1 = null;
                        c10961.label = 3;
                        return $this$sequence.yield(c10961.$input.subSequence(nextStart, c10961.$input.length()).toString(), c10961) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    c10961.L$0 = $this$sequence;
                    c10961.L$1 = matcher;
                    c10961.I$0 = splitCount;
                    ...
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c10961.$limit - 1) {
                    }
                    c10961.L$0 = null;
                    c10961.L$1 = null;
                    c10961.label = 3;
                    if ($this$sequence.yield(c10961.$input.subSequence(nextStart, c10961.$input.length()).toString(), c10961) == coroutine_suspended) {
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                case 2:
                    c10961 = this;
                    splitCount = c10961.I$0;
                    matcher = (Matcher) c10961.L$1;
                    $this$sequence = (SequenceScope) c10961.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c10961.$limit - 1) {
    ...
    /* compiled from: Regex.kt */
    @Metadata(m145d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u0000 \u000e2\u00060\u0001j\u0002`\u0002:\u0001\u000eB\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\f\u001a\u00020\rH\u0002R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u000f"}, m146d2 = {"Lkotlin/text/Regex$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", "flags", "", "(Ljava/lang/String;I)V", "getFlags", "()I", "getPattern", "()Ljava/lang/String;", "readResolve", "", "Companion", "kotlin-stdlib"}, m147k = 1, m148mv = {1, 9, 0}, m150xi = 48)
    ...
    /* compiled from: Regex.kt */
    @Metadata(m145d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\t\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\n\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u0007¨\u0006\f"}, m146d2 = {"Lkotlin/text/Regex$Companion;", "", "()V", "ensureUnicodeCase", "", "flags", "escape", "", "literal", "escapeReplacement", "fromLiteral", "Lkotlin/text/Regex;", "kotlin-stdlib"}, m147k = 1, m148mv = {1, 9, 0}, m150xi = 48)
