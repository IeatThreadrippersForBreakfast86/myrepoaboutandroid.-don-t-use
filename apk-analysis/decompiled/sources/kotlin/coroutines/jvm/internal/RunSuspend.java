...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1460getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m254boximpl(result);
