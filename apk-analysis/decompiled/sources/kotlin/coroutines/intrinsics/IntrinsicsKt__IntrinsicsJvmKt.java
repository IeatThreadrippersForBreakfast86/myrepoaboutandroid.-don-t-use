...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Object wrapWithContinuationImpl(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> completion) {
        Intrinsics.checkNotNullParameter(function1, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
        Continuation newCompletion = m160xca667f36(DebugProbesKt.probeCoroutineCreated(completion));
    ...
    private static final <T> Continuation<T> m160xca667f36(final Continuation<? super T> continuation) {
        final CoroutineContext context = continuation.getContext();
        if (context == EmptyCoroutineContext.INSTANCE) {
