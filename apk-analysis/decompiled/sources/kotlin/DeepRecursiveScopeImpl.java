    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m257equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m255constructorimpl(objWrapWithContinuationImpl));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        continuation.resumeWith(Result.m255constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
